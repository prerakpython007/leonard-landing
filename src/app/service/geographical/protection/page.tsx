...
import { Shield, Search, Gavel, BookOpen, X } from 'lucide-react';
...
const giServices = [
  {
    ...
    image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvdGVjdGlvbnxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80",
    category: "Prevention",
  },
  {
    icon: Search,
    ...
    image: "https://media.istockphoto.com/id/1321462048/photo/digital-eye-with-tag-symbol.jpg?s=612x612&w=0&k=20&c=4K42LSk-cp5YrKYZk3h7cZZ2NEfReXZBzKXq4aUPzHg=",
    category: "Monitoring",
  },
  {
    icon: Gavel,
    ...
    image: "https://media.istockphoto.com/id/1189303589/photo/the-lawyer-in-court.jpg?s=612x612&w=0&k=20&c=4h0Vx9QfqJkq1x5uVlDnqJRL9Y1Z8Q8Q9Q9Q9Q9Q9Q=",
    category: "Legal",
  },
  {
    icon: BookOpen,
    ...
    image: "https://media.istockphoto.com/id/1322220448/photo/empty-classroom.jpg?s=612x612&w=0&k=20&c=4h0Vx9QfqJkq1x5uVlDnqJRL9Y1Z8Q8Q9Q9Q9Q9Q9Q=",
    category: "Education",
  },
];

const benefits = [
  'Prevent unauthorized use of your geographical indication',
  'Maintain product reputation and authenticity',
  'Protect market value and economic benefits',
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2VvZ3JhcGhpY2FsJTIwaW5kaWNhdGlvbnxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80"
            alt="GI Protection hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert protection services to safeguard your Geographical Indications, from regional products to traditional crafts.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              >
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      GI Protection Overview
                    </motion.h1>

                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in Geographical Indication protection to safeguard your regional products and traditional knowledge. Our skilled team provides expert advice on GI registration, enforcement, and management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our GI protection services include misuse prevention, market monitoring, legal support, and stakeholder education to ensure your geographical indications are protected effectively.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://media.istockphoto.com/id-1368749245/photo/geographical-indications-concept.jpg?s=612x612&w=0&k=20&c=4h0Vx9QfqJkq1x5uVlDnqJRL9Y1Z8Q8Q9Q9Q9Q9Q9Q=" alt="GI Protection visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="relative px-4 bg-[#000000] py-12 md:py-16 lg:py-24 md:px-16 lg:px-24">
        <div className="relative mx-auto max-w-7xl">
          <div className="mt-16 md:mt-24 lg:mt-32">
            ...
            <motion.div
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 px-2 sm:px-4 md:px-16"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              ...
              {giServices.map((service, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <p className="text-white text-sm font-light text-center">{service.description}</p>
