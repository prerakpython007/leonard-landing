...
import { BookOpen, ChartBar, Globe, Search } from 'lucide-react';
...
export default function GIConsultationPage() {
  ...
  const consultationPoints = [
    'Access to GI experts with global experience',
    'Tailored strategies to meet your specific goals',
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6">
              <p className="text-base sm:text-lg leading-relaxed">
                Navigating the world of Geographical Indications (GI) can be complex. At Leonard Corporate Solutions, our GI consultation services provide you with expert advice to strategize and optimize your GI portfolio for maximum impact.
              </p>
              <h3 className="text-xl sm:text-2xl font-bold text-[#222831] mt-6 sm:mt-8 mb-4">Why Consult with Us?</h3>
              <ul className="space-y-3 sm:space-y-4 list-none pl-4 sm:pl-5">
                {consultationPoints.map((point, index) => (
                  <li
                    key={index}
                    className="relative pl-5 sm:pl-6 text-sm sm:text-base before:content-['✦'] before:absolute before:left-0 before:text-[#00ADB5]"
                  >
                    {point}
                  </li>
                ))}
          ...
          >
            <div className="relative py-8 sm:py-12">
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Maximize Your GI Portfolio with Expert Guidance</h2>
              <p className="text-[#393E46] text-sm sm:text-lg leading-relaxed mb-6">
                Ready to take your GI portfolio to the next level? Schedule a consultation with us today!
              </p>
              <Link
                href="/contact-us"
