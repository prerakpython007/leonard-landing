...
import { Globe, Shield, FileCheck, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for International GI service info
interface InternationalServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const internationalServices = [
  {
    ...
    detailedContent: `• Comprehensive guidance for international GI registration
• Assistance with preparing and filing application documents in multiple jurisdictions
• Coordination with foreign IP offices and agencies
• Management of international application timelines
• Handling of objections and responses across different legal systems
• Final registration certificate procurement in target countries`
  },
  {
    icon: Shield,
    ...
    category: "Protection",
    detailedContent: `• Development of comprehensive international GI protection strategies
• Global market analysis and risk assessment
• Implementation of quality control systems across borders
• Creation of usage guidelines for international authorized producers
• Monitoring of potential infringements in global markets
• Development of international enforcement protocols`
  },
  {
    icon: FileCheck,
    title: 'Compliance',
    ...
    category: "Compliance",
    detailedContent: `• Expert guidance on international GI treaties and agreements
• Assistance with compliance to TRIPS Agreement requirements
• Guidance on EU PDO/PGI systems compliance
• Management of international labeling and marking requirements
• Advice on customs recordals and border enforcement measures
• Assistance with bilateral and multilateral GI agreements`
  }
];

const benefits = [
  'Protect your regional products in global markets with expert international GI guidance',
  "Enhance your product's international reputation and value through strategic GI management",
  'Navigate complex international regulations with ease using our specialized expertise',
];

export default function InternationalGIPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<InternationalServiceInfo | null>(null);

  const handleExploreClick = (info: InternationalServiceInfo) => {
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1519677100203-a0e668c92439?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
            alt="International GI Services hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Global Registration & Protection for Your Geographical Indications
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in international Geographical Indication (GI) protection to safeguard your regional products across global markets. Our expert team provides comprehensive guidance on international GI registration, management, and enforcement.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our international GI services include global registration assistance, international protection strategies, compliance with international laws and treaties, and cross-border enforcement to ensure your regional products receive worldwide protection.
                    </p>
                    <p className="text-base md:text-lg font-medium text-[#393E46]">
                      📩 For tailored international GI advice, reach out:{" "}
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1531058020387-3be344556be6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="International GI Services visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm">
              <h2 className="text-[#eeeeee] text-2xl md:text-3xl lg:text-4xl font-extrabold text-center mb-6 md:mb-8"
                ...
                Why International GI Protection?
              </h2>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our international GI protection services ensure your regional products receive global recognition and protection with strategic guidance and comprehensive expertise.
              </p>
              <Link
                href="/contact"
              ...
              >
                Start Your International GI Registration
