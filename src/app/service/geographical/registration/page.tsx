    ...
    <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[5%] font-montserrat">
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-[#222831] mb-4">Register Your Geographical Indication</h2>
            <p className="text-[#393E46]/80 mb-6">
              GI registration protects products like Darjeeling Tea or Kancheepuram Silk by linking them to their geographical origin, ensuring authenticity and exclusivity. At DesignSecure, we simplify the registration process under the GI Act, 1999, helping producers safeguard their heritage and market position.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">GI Registration Essentials</h2>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24 bg-[#F7F7F7]">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">Types of GI Products</h2>
            <div className="w-24 h-1 bg-[#00ADB5] mx-auto rounded-full"></div>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">Agricultural Products</h3>
              <p className="text-[#393E46]/80">E.g., Darjeeling Tea, Alphonso Mango, linked to specific regions.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">Handicrafts</h3>
              <p className="text-[#393E46]/80">E.g., Banarasi Saree, Madhubani Paintings with regional significance.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">Manufactured Goods</h3>
              <p className="text-[#393E46]/80">E.g., Kolhapuri Chappal, Mysore Silk with unique regional traits.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">Foodstuffs</h3>
              <p className="text-[#393E46]/80">E.g., Bikaneri Bhujia, Nagpur Orange tied to specific regions.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">GI Registration Process in India</h2>
            <div className="w-24 h-1 bg-[#00ADB5] mx-auto rounded-full"></div>
          </motion.div>
          <div className="space-y-6">
            <motion.div
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">1. Identify the Product</h3>
              <p className="text-[#393E46]/80">Confirm the product’s unique qualities and link to its geographical origin.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-[#393E46]/80">Submit evidence of origin, product specs, and producer details to the GI Registry.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-[#393E46]/80">The GI Registry reviews for compliance and authenticity.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-[#393E46]/80">If approved, the GI is registered for 10 years, renewable.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">Ready to Register Your GI?</h2>
            <p className="text-[#393E46]/80 mb-6 max-w-2xl mx-auto">
              Protect your region’s unique products with DesignSecure’s expert GI registration services. Start today to ensure authenticity and exclusivity.
            </p>
            <Link
              href="/contact-us"
