  ...
  return (
    <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[50px] sm:rounded-b-[100px] md:rounded-b-[170px] font-montserrat overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      {showPopup && selectedInfo && (
        ...
        >
          <motion.div
            className="bg-white rounded-xl w-full max-w-[90vw] sm:max-w-[80vw] md:max-w-3xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 md:p-10 shadow-xl border border-black/20 relative"
          ...
          >
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#222831] mb-4 sm:mb-6 border-b-2 border-black/30 pb-2">
              {selectedInfo.title}
            </h2>
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-black">Our GI</span>{' '}
