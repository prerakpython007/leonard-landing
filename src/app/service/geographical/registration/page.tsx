...
import { X, Search, FileText, Shield, FilePenLine, ShieldCheck } from 'lucide-react';
...
const giRegistrationInfo: GIRegistrationInfo[] = [
  {
    ...
    category: 'Basics',
    image: "https://images.unsplash.com/photo-1616401784845-880c3cb5f4c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    detailedContent: `
...
const giServices = [
  {
    icon: Search,
    title: 'GI Analysis',
    description: 'We assess the eligibility and registrability of your geographical indication.',
  ...
  },
  {
    ...
    description: 'We develop tailored plans for GI registration and protection.',
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    category: "Strategy",
  },
  {
    ...
    description: 'We help protect your GI against infringement and misuse.',
    image: "https://images.unsplash.com/photo-1587202372775-e229f172b9d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    category: "Protection",
  },
];

const benefits = [
  'Make informed decisions with expert GI protection guidance',
  'Optimize protection with tailored registration strategies',
  'Maximize value through strategic GI management',
];
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1616401784845-880c3cb5f4c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80"
            alt="GI Registration hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert GI protection services to safeguard your regional products, from agricultural goods to handicrafts with geographical significance.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              >
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      GI Registration Overview
                    </motion.h1>

                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in Geographical Indication (GI) registration to protect your region-specific products. Our skilled team provides expert advice on GI registration, enforcement, and management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our GI protection services include eligibility analysis, registration strategy, enforcement support, and strategic planning to ensure your geographical indications are protected effectively.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1616401784845-880c3cb5f4c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="GI Registration visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="relative px-4 bg-[#000000] py-12 md:py-16 lg:py-24 md:px-16 lg:px-24">
        <div className="relative mx-auto max-w-7xl">
          ...
          {/* GI Information Cards */}
        <motion.div 
  className="relative mx-auto mt-16 md:mt-24 lg:mt-32" 
  initial={{ opacity: 0, y: 20 }} 
  whileInView={{ opacity: 1, y: 0 }} 
  transition={{ duration: 0.8 }} 
  viewport={{ once: true }}
>
  <h2 className="text-[#eeeeee] text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-center mb-8 md:mb-12 lg:mb-16"
      style={{
        letterSpacing: "0.2em",
        textShadow: "-1px 0px 0px rgba(100, 100, 100, 0.6), -3px 1px 0px rgba(80, 80, 80, 0.4)",
      }}>
    GI Registration Information
  </h2>
  
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 px-2 sm:px-4 md:px-16">
    {giRegistrationInfo.map((info, index) => (
      <motion.div
        key={info.id}
        className="relative h-64 sm:h-72 md:h-80 overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 group"
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        ...
        {/* Description - Bottom on Hover */}
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <p className="text-white text-sm text-center mb-2">{info.description}</p>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our GI protection services ensure your regional products are protected with strategic guidance and comprehensive expertise.
              </p>
              <Link
                href="/contact"
