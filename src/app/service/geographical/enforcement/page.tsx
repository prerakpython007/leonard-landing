...
const enforcementServices = [
  {
    ...
    detailedContent: `• Comprehensive monitoring of markets for potential infringements
• Digital surveillance for unauthorized online use of your GI
• Field investigations to identify physical instances of passing off
• Evidence collection and documentation for legal proceedings
• Analysis of infringement patterns and scale
• Coordination with local authorities for investigation support`
  },
  {
    icon: Gavel,
    title: 'Legal Action',
    ...
    category: "Legal",
    detailedContent: `• Preparation and filing of civil lawsuits for GI infringement
• Coordination with law enforcement for criminal actions when applicable
• Drafting and serving cease and desist notices to violators
• Representation in court proceedings and hearings
• Management of opposition and cancellation proceedings
• Assistance with border enforcement measures and customs recordals`
  },
  {
    icon: Handshake,
    title: 'Resolution',
    ...
    category: "Resolution",
    detailedContent: `• Negotiation of settlement agreements with infringing parties
• Mediation and alternative dispute resolution services
• Monitoring compliance with court orders and settlements
• Development of licensing agreements when appropriate
• Implementation of corrective measures to prevent future violations
• Restoration of market秩序 and consumer confidence`
  },
];
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg font-medium text-[#393E46]">
                      📩 For enforcement assistance, reach out:{" "}
