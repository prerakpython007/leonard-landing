  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Resolve contract disputes through settlement or litigation support. Protect your business with our expert dispute resolution services in India and globally."
        />
        <meta
          name="keywords"
          content="contract dispute resolution, resolve contract disputes, settlement litigation support, business conflict resolution"
        />
        <title>Contract Dispute Resolution Services | Resolve Conflicts Efficiently</title>
      ...
      <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[170px] font-montserrat overflow-hidden">
            ...
            >
              ...
              <div className="text-center space-y-6">
                <h2 className="text-4xl font-bold mb-4">
                  <span className="text-[#00ADB5]">Resolve Contract Disputes</span>{' '}
                  <span className="text-[#393E46]">Efficiently</span>
                </h2>
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Contract disputes can disrupt your business and lead to financial losses. At [Your Company Name], we provide expert dispute resolution services, offering settlement or litigation support to resolve conflicts efficiently in India and internationally.
                </p>
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24 bg-[#F7F7F7]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-4 md:px-16">
              {[
                { title: 'Minimize Disruptions', description: 'Resolve conflicts quickly to minimize business disruptions.' },
                { title: 'Protect Interests', description: 'Protect your financial interests with effective resolutions.' },
                { title: 'Maintain Relationships', description: 'Maintain business relationships through amicable settlements.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 w-8 h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-8 -right-8 w-8 h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-4xl font-bold mb-4">Resolve Contract Disputes Effectively</h2>
              <p className="text-[#393E46] text-lg leading-relaxed mb-6">
                Contact us for dispute resolution services!
              </p>
              <Link
                href="/contact-us"
