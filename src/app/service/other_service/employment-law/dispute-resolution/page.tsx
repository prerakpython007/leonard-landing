...
const disputeInfo: DisputeInfo[] = [
  {
    ...
    detailedContent: `
      • Handle grievances under the Industrial Disputes Act, 1947.
      • Facilitate mediation and conciliation for workplace complaints.
      • Develop grievance redressal mechanisms compliant with labour laws.
      • Ensure timely resolution to maintain workplace harmony.
      • Provide documentation for grievance processes and outcomes.
      • Offer training for HR teams on grievance handling.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Provide legal support for wrongful termination claims.
      • Ensure compliance with termination procedures under labour laws.
      • Represent clients in labour courts or tribunals for termination disputes.
      • Mediate between employers and employees to avoid litigation.
      • Draft settlement agreements to resolve disputes amicably.
      • Advise on reinstatement or compensation options.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Address disputes under the Payment of Wages Act and Minimum Wages Act.
      • Mediate conflicts over unpaid wages, overtime, or bonuses.
      • Ensure compliance with EPF, ESI, and gratuity regulations.
      • Provide legal representation in wage-related labour disputes.
      • Draft agreements to settle compensation disputes.
      • Advise on wage policy updates to prevent future conflicts.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Resolve complaints under the Sexual Harassment of Women at Workplace Act, 2013.
      • Support Internal Committee (IC) inquiries and proceedings.
      • Ensure compliance with POSH inquiry and reporting requirements.
      • Mediate between parties for fair and confidential resolutions.
      • Provide legal representation in POSH-related disputes.
      • Offer training on POSH compliance and dispute handling.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Handle disputes under the Contract Labour (Regulation and Abolition) Act.
      • Mediate conflicts between contractors, workers, and employers.
      • Ensure compliance with wage, PF, and ESI obligations for contract labour.
      • Provide legal support in labour court or tribunal proceedings.
      • Draft settlement agreements for contract labour disputes.
      • Advise on contractor agreements to minimize disputes.
    `,
  },
];
