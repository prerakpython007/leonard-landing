...
const auditInfo: AuditInfo[] = [
  {
    ...
    detailedContent: `
      • Audit compliance with Shops and Establishments Act, Minimum Wages Act, and Payment of Wages Act.
      • Verify adherence to Employees’ Provident Fund (EPF) and Employees’ State Insurance (ESI) regulations.
      • Ensure compliance with Contract Labour (Regulation and Abolition) Act for contract workers.
      • Review policies under the Sexual Harassment of Women at Workplace (Prevention, Prohibition, and Redressal) Act, 2013.
      • Assess compliance with maternity benefits and gratuity laws.
  ...
  },
  {
    ...
    detailedContent: `
      • Verify compliance with Minimum Wages Act and state-specific wage rules.
      • Audit payroll records for accurate salary, overtime, and deduction calculations.
      • Ensure timely PF and ESI contributions as per EPF and ESI Acts.
      • Review bonus payments under the Payment of Bonus Act, 1965.
      • Check compliance with equal remuneration laws.
      • Provide guidance on rectifying payroll discrepancies.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Review employee handbooks and HR policies for compliance with Indian labour laws.
      • Ensure policies align with the Industrial Disputes Act and Factories Act.
      • Verify implementation of POSH (Prevention of Sexual Harassment) policies and Internal Committees.
      • Assess leave policies under state-specific Shops and Establishments Acts.
      • Check compliance with health, safety, and welfare provisions.
      • Recommend updates to policies for legal alignment.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Verify timely submission of EPF, ESI, and professional tax returns.
      • Audit maintenance of statutory registers (e.g., attendance, wages, leave).
      • Ensure compliance with record-keeping under the Contract Labour Act and Factories Act.
      • Review annual returns under labour welfare and maternity benefit laws.
      • Check compliance with apprenticeship and internship regulations.
      • Provide checklists for accurate record-keeping.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Conduct risk assessments for employment law violations.
      • Identify gaps in compliance with labour inspections and audits.
      • Develop mitigation plans for penalties, fines, or legal disputes.
      • Provide training on compliance best practices for HR teams.
      • Ensure preparedness for government inspections or inquiries.
      • Support resolution of employee grievances to avoid litigation.
    `,
  },
];
