      ...
      <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[170px] font-montserrat overflow-hidden">
            ...
            >
              ...
              <div className="text-center space-y-6">
                ...
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Filing the right documents with authorities is key to maintaining compliance. At [Your Company Name], we provide seamless document filing services to ensure your business meets all employment law requirements in India and internationally.
                </p>
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24 bg-[#F7F7F7]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-4 md:px-16">
              {[
                { title: 'Avoid Penalties', description: 'Avoid fines by meeting all filing deadlines and requirements.' },
                { title: 'Ensure Compliance', description: 'Ensure compliance with employment law regulations.' },
                { title: 'Save Time', description: 'Save time and focus on your business while we handle filings.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 w-8 h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-8 -right-8 w-8 h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-4xl font-bold mb-4">Ready to Streamline Your Legal Filings?</h2>
