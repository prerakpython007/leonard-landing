...
const policyInfo: PolicyInfo[] = [
  {
    ...
    detailedContent: `
      • Draft employee handbooks compliant with Shops and Establishments Act.
      • Develop leave policies aligned with state-specific regulations.
      • Create policies for overtime, wages, and benefits per Minimum Wages Act.
      • Ensure compliance with Employees’ Provident Fund (EPF) and ESI schemes.
      • Incorporate grievance redressal mechanisms as per Industrial Disputes Act.
      • Provide templates customizable for business size and industry.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Draft policies under the Sexual Harassment of Women at Workplace Act, 2013.
      • Establish Internal Committee (IC) guidelines and procedures.
      • Include training protocols for employees and IC members.
      • Ensure compliance with annual reporting and inquiry processes.
      • Address workplace safety and confidentiality requirements.
      • Provide customizable POSH policy templates for all industries.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Develop health and safety policies per Factories Act, 1948.
      • Include provisions for workplace hygiene, fire safety, and emergency protocols.
      • Ensure compliance with labour welfare regulations.
      • Address occupational health requirements for hazardous industries.
      • Draft policies for employee wellness and mental health support.
      • Provide industry-specific safety policy frameworks.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Draft policies compliant with Contract Labour (Regulation and Abolition) Act.
      • Include guidelines for contractor agreements and worker welfare.
      • Ensure compliance with wage, PF, and ESI obligations for contract labour.
      • Develop policies for onboarding, supervision, and termination of contract workers.
      • Address record-keeping and statutory filings for contract labour.
      • Provide templates for multi-contractor or multi-site operations.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Review existing policies for compliance with updated labour laws.
      • Update policies to reflect changes in EPF, ESI, or POSH regulations.
      • Align policies with new state or central government mandates.
      • Conduct periodic audits to identify policy gaps.
      • Provide revised policy documents with clear implementation guidelines.
      • Support training for employees on updated policies.
    `,
  },
];
