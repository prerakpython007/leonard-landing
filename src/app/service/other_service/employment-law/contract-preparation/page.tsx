...
interface ContractPreparationInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const contractPreparationInfo: ContractPreparationInfo[] = [
  {
    id: 1,
    title: 'Custom Drafting',
    description: 'We create contracts tailored to your business and employee roles.',
    category: 'Contract Customization',
    detailedContent: `
      • Draft contracts specific to your business needs and roles.
      • Include role-specific terms for clarity and alignment.
      • Tailor contracts for full-time, part-time, or contract employees.
      • Ensure contracts reflect your organizational policies.
      • Provide flexible templates for future hiring needs.
    `,
  },
  {
    id: 2,
    title: 'Compliance Check',
    description: 'We ensure contracts meet employment law requirements.',
    category: 'Legal Compliance',
    detailedContent: `
      • Verify contracts comply with local and international labor laws.
      • Ensure adherence to wage, hour, and termination regulations.
      • Review contracts for anti-discrimination compliance.
      • Mitigate risks of non-compliant contract terms.
      • Update contracts to reflect regulatory changes.
    `,
  },
  {
    id: 3,
    title: 'Key Clauses',
    description: 'We include non-compete, confidentiality, and termination clauses for protection.',
    category: 'Protective Clauses',
    detailedContent: `
      • Include non-compete clauses to protect business interests.
      • Draft confidentiality clauses to safeguard sensitive data.
      • Define clear termination clauses for legal protection.
      • Ensure clauses are enforceable under applicable laws.
      • Customize clauses to balance employer and employee rights.
    `,
  },
];

export default function ContractPreparationPage() {
  const [showPopup, setShowPopup] = useState<boolean>(false);
  const [selectedInfo, setSelectedInfo] = useState<ContractPreparationInfo | null>(null);

  const handleExploreClick = (info: ContractPreparationInfo) => {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Professionally drafted employment contracts and agreements to protect your business. Ensure clarity and compliance in India and globally with our expert services."
        />
        <meta
          name="keywords"
          content="employment contract preparation, draft employment agreements, business employment contracts, legal contract services"
        />
        <title>Employment Contract Preparation | Professionally Drafted Agreements</title>
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  <span className="text-[#00ADB5]">Protect Your Business</span>{' '}
                  <span className="text-[#393E46]">with Professionally Drafted Contracts</span>
                </h2>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  Employment contracts set clear expectations for your workforce. At [Your Company Name], we provide professionally drafted employment contracts and agreements to ensure clarity, compliance, and protection for your business in India and internationally.
                </p>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg font-medium">
                  ...
                  to secure your workforce today.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-[#00ADB5]">Preparation Services</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {contractPreparationInfo.map((info: ContractPreparationInfo, index: number) => (
                <motion.div
                  key={info.id}
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-[#00ADB5]">Contract Preparation</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Prevent Disputes', description: 'Prevent disputes with clear terms and conditions.' },
                { title: 'Ensure Compliance', description: 'Ensure compliance with local and international labor laws.' },
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Secure Your Workforce?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Protect your business with professionally drafted employment contracts. Partner with [Your Company Name] today.
              </p>
              <Link
                href="/contact-us"
