...
const legalAdvisoryInfo: LegalAdvisoryInfo[] = [
  {
    id: 1,
    title: 'Regulatory Guidance',
    description: 'We provide advice on employment law regulations.',
    category: 'Compliance Advice',
    detailedContent: `
      • Offer expert guidance on local and international employment laws.
      • Advise on compliance with wage, hour, and leave regulations.
      • Provide insights into anti-discrimination and workplace safety laws.
      • Help navigate complex regulatory frameworks.
      • Ensure your policies align with current legal standards.
    `,
  },
  {
    id: 2,
    title: 'Risk Assessment',
    description: 'We assess legal risks in your HR practices.',
    category: 'Risk Management',
    detailedContent: `
      • Evaluate HR practices for potential legal risks.
      • Identify vulnerabilities in employment policies.
      • Assess compliance with termination and discipline procedures.
      • Provide recommendations to mitigate legal exposure.
  ...
  },
  {
    ...
    description: 'We help plan HR strategies to avoid legal issues.',
    category: 'HR Strategy',
    detailedContent: `
      • Develop HR strategies aligned with employment laws.
      • Plan for compliant hiring, onboarding, and termination processes.
      • Advise on employee benefits and compensation structures.
      • Support workforce expansion with legal compliance.
      • Ensure long-term legal stability in HR operations.
    `,
  },
];
...
export default function LegalAdvisoryPage() {
  ...
  const [selectedInfo, setSelectedInfo] = useState<LegalAdvisoryInfo | null>(null);

  const handleExploreClick = (info: LegalAdvisoryInfo) => {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Expert legal advisory for employment law compliance and risk management. Navigate legal complexities in India and globally with our professional guidance."
        />
        <meta
          name="keywords"
          content="employment law advisory, legal compliance guidance, business legal advisory, employment law consulting"
        />
        <title>Employment Law Advisory | Expert Legal Guidance</title>
          ...
          >
            ...
            >
              ...
              `}</style>
                <button
                onClick={closePopup}
                className="absolute top-2 right-2 sm:top-4 sm:right-4 p-1 sm:p-2 text-[#393E46] hover:text-black hover:bg-black/10 rounded-full"
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  <span className="text-black">Navigate Legal</span>{' '}
                  <span className="text-[#393E46]">Complexities with Expert Advisory</span>
                </h2>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  Navigating employment laws can be complex. At [Your Company Name], our legal advisory services provide expert guidance to ensure compliance and manage risks in India and internationally.
                </p>
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-black">Legal Advisory</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Avoid Legal Risks', description: 'Minimize legal risks with expert guidance.' },
                { title: 'Ensure Compliance', description: 'Stay compliant with employment regulations.' },
                { title: 'Strategic HR', description: 'Align HR strategies with legal requirements.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-black" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-black" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Navigate Legal Complexities?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Ensure compliance and manage risks with expert legal advisory services. Partner with [Your Company Name] today.
              </p>
              <Link
                href="/contact-us"
