...
const employmentLawInfo: EmploymentLawInfo[] = [
  {
    id: 1,
    title: 'Compliance Audits',
    description: 'We conduct audits to ensure workplace compliance.',
    category: 'Audit Services',
    detailedContent: `
      • Perform comprehensive audits of HR practices and policies.
      • Review employee records for compliance with labor laws.
      • Assess workplace safety and anti-discrimination compliance.
  ...
  },
  {
    ...
    description: 'We draft compliant employment contracts.',
    category: 'Contract Services',
    detailedContent: `
      • Create tailored employment contracts for various roles.
      • Ensure contracts comply with local and international laws.
      • Include protective clauses like non-compete and confidentiality.
      • Review existing contracts for legal compliance.
  ...
  },
  {
    ...
    description: 'We resolve workplace disputes efficiently.',
    category: 'Conflict Management',
    detailedContent: `
      • Facilitate mediation for amicable dispute resolution.
      • Provide legal support for arbitration or litigation.
      • Enforce workplace policies during dispute processes.
      • Document resolutions for compliance records.
...
export default function EmploymentLawPage() {
  ...
  const [selectedInfo, setSelectedInfo] = useState<EmploymentLawInfo | null>(null);

  const handleExploreClick = (info: EmploymentLawInfo) => {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Comprehensive employment law services including audits, contract drafting, and dispute resolution. Ensure compliance in India and globally with our expert solutions."
        />
        <meta
          name="keywords"
          content="employment law services, workplace compliance, employment contract drafting, dispute resolution services"
        />
        <title>Employment Law Services | Comprehensive Legal Solutions</title>
        <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600;7;800&display=swap" rel="stylesheet" />
      </Head>
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  ...
                  <span className="text-[#393E46]">with Comprehensive Employment Law Services</span>
                </h2>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  Employment law compliance is critical for business success. At [Your Company Name], we provide comprehensive services to ensure compliance and resolve disputes in India and internationally.
                </p>
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {employmentLawInfo.map((info: EmploymentLawInfo, index: number) => (
                <motion.div
                  key={info.id}
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-[#00ADB5]">Employment Law Services</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Ensure Compliance', description: 'Stay compliant with employment regulations.' },
                { title: 'Protect Business', description: 'Safeguard your business from legal risks.' },
                { title: 'Resolve Disputes', description: 'Resolve workplace disputes efficiently.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Safeguard Your Business?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Ensure compliance and protect your business with comprehensive employment law services. Partner with [Your Company Name] today.
              </p>
              <Link
                href="/contact-us"
