...
const legalDocInfo: LegalDocInfo[] = [
  {
    id: 1,
    title: 'Document Preparation',
    description: 'We prepare all required legal documents for FSSAI compliance.',
    category: 'Documentation',
    detailedContent: `
      • Draft comprehensive legal documents tailored to your FSSAI application needs.
      • Compile business details, product information, and compliance declarations.
      • Ensure all documents meet FSSAI’s Food Safety and Standards Regulations.
      • Provide templates for consistent and accurate documentation.
      • Review drafts to eliminate errors before submission.
    `,
  },
  {
    id: 2,
    title: 'Compliance Verification',
    description: 'We verify documents to ensure full compliance with FSSAI standards.',
    category: 'Compliance',
    detailedContent: `
      • Conduct thorough reviews of all legal documents for FSSAI compliance.
      • Verify alignment with Food Safety and Standards (Licensing and Registration) Regulations, 2011.
      • Check for completeness, accuracy, and adherence to FSSAI guidelines.
      • Address discrepancies or missing information promptly.
      • Provide detailed feedback to ensure regulatory readiness.
    `,
  },
  {
    id: 3,
    title: 'Submission Support',
    description: 'We assist in submitting legal documents to the FSSAI portal.',
    category: 'Submission',
    detailedContent: `
      • Handle document uploads and submissions via the FoSCoS portal.
      • Ensure all documents are formatted and submitted as per FSSAI requirements.
      • Track submission progress and address any portal-related issues.
      • Coordinate with FSSAI authorities for clarifications or additional requirements.
      • Provide confirmation of successful submission for your records.
    `,
  },
];

export default function FSSAILegalDocumentationPage() {
  const [showPopup, setShowPopup] = useState<boolean>(false);
  const [selectedInfo, setSelectedInfo] = useState<LegalDocInfo | null>(null);

  const handleExploreClick = (info: LegalDocInfo) => {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Comprehensive legal documentation support for FSSAI compliance. Ensure your food business in India meets all regulatory requirements with our expert services."
        />
        <meta
          name="keywords"
          content="FSSAI legal documentation, FSSAI compliance documents, food business documentation India, FSSAI submission support"
        />
        <title>FSSAI Legal Documentation | Comprehensive Support</title>
      ...
      <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[50px] sm:rounded-b-[100px] md:rounded-b-[170px] font-montserrat overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  ...
                  <span className="text-[#393E46]">Legal Documentation Support</span>
                </h2>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  Accurate and compliant legal documentation is critical for FSSAI registration and renewals. At [Your Company Name], we provide end-to-end support to prepare, verify, and submit legal documents, ensuring your food business in India meets all regulatory requirements.
                </p>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg font-medium">
                  ...
                  to streamline your FSSAI documentation today.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-[#F7F7F7]">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                <span className="text-[#222831]">Benefits of Our</span>{' '}
                <span className="text-[#00ADB5]">Documentation Support</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Error-Free Documents', description: 'Ensure error-free documents for seamless FSSAI approvals.' },
                { title: 'Time Efficiency', description: 'Save time with our streamlined documentation process.' },
                { title: 'Regulatory Compliance', description: 'Stay compliant with FSSAI regulations effortlessly.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Streamline Your FSSAI Documentation?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Ensure compliance with expertly prepared legal documents. Partner with [Your Company Name] to simplify your FSSAI documentation process.
              </p>
              <Link
                href="/contact-us"
