...
const eligibilityInfo: EligibilityInfo[] = [
  {
    ...
    detailedContent: `
      • Evaluate business scale (e.g., turnover, production capacity) to identify registration, state, or central license.
      • Assess operational scope (e.g., manufacturing, retail, import/export).
      • Review eligibility criteria under the FSS Act, 2006.
      • Provide guidance on micro, small, or large-scale business classifications.
      • Recommend license type based on business activities and locations.
      • Clarify multi-unit or multi-state licensing requirements.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Review compliance with FSSAI food safety standards and regulations.
      • Assess adherence to hygiene, sanitation, and labeling requirements.
      • Verify eligibility for specific food categories (e.g., processed, organic).
      • Ensure compliance with FSMS (Food Safety Management System) mandates.
      • Identify gaps in regulatory preparedness for licensing.
      • Provide actionable steps to meet FSSAI eligibility criteria.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Guide preparation of business registration documents (e.g., GST, PAN).
      • Identify required proofs (e.g., ID, address, premises ownership).
      • Assist with FSMS plans and declarations for eligibility.
      • Provide templates for affidavits, undertakings, and layout plans.
      • Ensure document accuracy to meet FSSAI eligibility standards.
      • Organize records for eligibility verification and inspections.
    `,
  },
  {
    id: 4,
    title: 'Business-Specific Consultation',
    description: 'Tailored advice for your food business’s unique FSSAI requirements.',
    category: 'Custom Solutions',
    detailedContent: `
      • Offer personalized consultation for restaurants, manufacturers, or e-commerce food businesses.
      • Address eligibility for specialized operations (e.g., cloud kitchens, exporters).
      • Provide guidance for startups and home-based food businesses.
      • Assess multi-product or multi-location licensing needs.
      • Recommend strategies to streamline eligibility processes.
      • Support businesses transitioning to higher license categories.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Conduct pre-inspection reviews to verify eligibility compliance.
      • Assess premises for hygiene, sanitation, and safety standards.
      • Ensure documentation aligns with FSSAI inspection requirements.
      • Identify and resolve potential eligibility issues before inspections.
      • Provide training on FSSAI inspection protocols.
      • Support post-inspection corrections to secure license approval.
    `,
  },
];
