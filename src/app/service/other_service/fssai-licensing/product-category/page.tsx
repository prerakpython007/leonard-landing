...
const categoryInfo: CategoryInfo[] = [
  {
    ...
    detailedContent: `
      • Identify appropriate FSSAI food product categories (e.g., dairy, bakery, beverages).
      • Map products to FSSAI’s Food Product Standards and Food Additives Regulations, 2011.
      • Classify products as standardized, proprietary, or novel foods.
      • Ensure alignment with HS codes for import/export products.
      • Provide guidance on multi-ingredient or composite products.
      • Clarify categorization for licensing and labeling requirements.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Verify compliance with FSSAI standards for each product category.
      • Ensure adherence to ingredient, additive, and contaminant limits.
      • Confirm labeling requirements (e.g., nutritional info, allergen declarations).
      • Address category-specific packaging and storage regulations.
      • Provide guidance on health claims and functional foods.
      • Mitigate risks of non-compliance penalties or product recalls.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Categorize organic, vegan, or gluten-free products under FSSAI guidelines.
      • Address novel foods, nutraceuticals, or health supplements.
      • Classify imported or specialty products (e.g., gourmet, ethnic foods).
      • Provide guidance for artisanal or home-based food products.
      • Ensure compliance for multi-category or hybrid products.
      • Support certification for specific categories (e.g., organic, halal).
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Draft FSSAI-compliant labels for each product category.
      • Include mandatory details (e.g., ingredients, expiry, batch number).
      • Ensure allergen and nutritional labeling meets category standards.
      • Prepare documentation for FSSAI applications reflecting product categories.
      • Provide templates for category-specific declarations.
      • Support audits by ensuring category-aligned records.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Update product categories for new or reformulated products.
      • Reclassify products due to changes in FSSAI regulations.
      • Support amendments in FSSAI licenses for category changes.
      • Ensure compliance during category transitions or expansions.
      • Provide guidance on FoSCoS portal updates for categories.
      • Mitigate risks of misclassification during inspections.
    `,
  },
];
