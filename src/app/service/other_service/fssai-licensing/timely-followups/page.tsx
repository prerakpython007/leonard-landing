...
const followUpInfo: FollowUpInfo[] = [
  {
    ...
    detailedContent: `
      • Track real-time status of Basic, State, or Central License applications on the FoSCoS portal.
      • Provide regular updates on application processing stages.
      • Identify delays or bottlenecks in the FSSAI approval process.
      • Ensure timely escalation for stalled applications.
      • Notify clients of status changes or approval milestones.
      • Maintain records of all FoSCoS interactions for transparency.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      ...
      • Draft and submit clarifications for application deficiencies.
      • Coordinate with FSSAI officials to resolve complex issues.
      • Ensure compliance with query requirements under FSS Act, 2006.
      • Provide clients with clear guidance on required actions.
      • Expedite query resolution to maintain application momentum.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Schedule and coordinate FSSAI inspections for State or Central Licenses.
      • Prepare businesses for hygiene, safety, and FSMS compliance checks.
      • Follow up with FSSAI officials on inspection outcomes.
      • Address post-inspection deficiencies or corrective actions.
      • Ensure inspection reports are processed promptly.
      • Support clients in meeting FSSAI inspection standards.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Analyze reasons for FSSAI application rejections.
      • Prepare and submit corrected documents or revised applications.
      • File appeals with FSSAI authorities for rejected applications.
      • Follow up on appeal progress and ensure timely resolution.
      • Provide guidance on compliance to prevent future rejections.
      • Support re-submission for seamless approval.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Track final stages of FSSAI application approval.
      • Verify issuance of 14-digit FSSAI license number.
      • Follow up on delays in license delivery via FoSCoS.
      • Ensure license details (e.g., validity, categories) are accurate.
      • Assist with license activation and compliance requirements.
      • Provide post-issuance guidance for renewals or amendments.
    `,
  },
];
