...
const draftingInfo: DraftingInfo[] = [
  {
    ...
    detailedContent: `
      • Draft Form A for basic FSSAI registration (small businesses).
      • Prepare Form B for state or central FSSAI licenses (medium/large businesses).
      • Ensure accurate details for business type, products, and operations.
      • Align applications with FSSAI eligibility criteria (FSS Act, 2006).
      • Include mandatory declarations and undertakings.
      • Optimize applications for submission via the FoSCoS portal.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Gather business registration documents (e.g., GST, PAN, incorporation certificate).
      • Prepare identity and address proofs for owners/partners.
      • Draft food safety management system (FSMS) plans.
      • Compile premises layout plans and water test reports.
      • Ensure all documents meet FSSAI submission standards.
      • Provide checklists to avoid missing or incorrect documents.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Incorporate compliance with FSSAI food safety and labeling requirements.
      • Ensure applications reflect hygiene and sanitation standards.
      • Address specific product category compliance (e.g., processed, organic).
      • Include provisions for FSMS and regulatory audits.
      • Mitigate risks of application rejection due to non-compliance.
      • Provide guidance on post-submission compliance checks.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Conduct thorough reviews of draft FSSAI applications.
      • Verify accuracy of business details, products, and compliance data.
      • Edit applications to address FSSAI feedback or rejections.
      • Ensure consistency across application forms and supporting documents.
      • Provide revisions for multi-unit or multi-state applications.
      • Optimize applications for faster FSSAI approval.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Draft applications for specialized food businesses (e.g., cloud kitchens, exporters).
      • Address complex cases like multi-product or multi-location licensing.
      • Provide tailored solutions for startups and home-based food businesses.
      • Draft applications for importers or organic food certifications.
      • Ensure applications align with specific business models.
      • Support amendments for business expansions or changes.
    `,
  },
];
