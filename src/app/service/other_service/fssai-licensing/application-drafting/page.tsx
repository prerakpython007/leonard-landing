...
// Define the interface for Application Drafting Services info
...
const draftingInfo: DraftingInfo[] = [
  {
    ...
    description: 'We draft Form A (Basic Registration) or Form B (State/Central License) accurately.',
    category: 'Drafting',
    detailedContent: `
      • Prepare Form A for small-scale food businesses (Basic Registration).
      • Draft Form B for medium to large-scale businesses (State or Central License).
      • Ensure all required fields are accurately filled as per FSSAI guidelines.
      • Customize forms based on business type and operational scale.
      • Review drafts to prevent errors before submission.
    `,
  },
  {
    id: 2,
    title: 'Detail Verification',
    description: 'We ensure all business details are correctly included.',
    category: 'Verification',
    detailedContent: `
      • Verify business details such as name, address, and contact information.
      • Cross-check operational details like turnover and product categories.
      • Ensure consistency with supporting documents (e.g., GST, PAN).
      • Validate eligibility criteria for the chosen FSSAI license type.
      • Provide corrections to avoid discrepancies in the application.
    `,
  },
  {
    id: 3,
    title: 'Compliance Check',
    description: 'We align your application with FSSAI regulations.',
    category: 'Compliance',
    detailedContent: `
      • Ensure applications meet Food Safety and Standards Act, 2006 requirements.
      • Align forms with FSSAI eligibility and documentation standards.
      • Include mandatory details like food safety management plans.
      • Conduct pre-submission checks to ensure regulatory compliance.
      • Advise on additional requirements for specific food business types.
    `,
  },
];

export default function FSSAIApplicationDraftingPage() {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Professionally drafted FSSAI applications to ensure smooth registration. Simplify your FSSAI licensing process in India with our expert drafting services."
        />
        <meta
          name="keywords"
          content="FSSAI application drafting, FSSAI registration application, food license drafting, FSSAI compliance services"
        />
        <title>FSSAI Application Drafting | Professionally Crafted Applications</title>
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  <span className="text-[#00ADB5]">Professionally Drafted</span>{' '}
                  <span className="text-[#393E46]">FSSAI Applications</span>
                </h2>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  A well-drafted application is key to a smooth FSSAI registration process. At [Your Company Name], we provide professionally drafted applications (Form A or Form B) to ensure your FSSAI registration is accurate and compliant in India.
                </p>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg font-medium">
                  ...
                  to simplify your FSSAI application today.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                <span className="text-[#222831]">Our Application</span>{' '}
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-[#00ADB5]">Application Drafting</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Reduce Rejection Risk', description: 'Reduce the risk of application rejection with professional drafting.' },
                { title: 'Save Time', description: 'Save time by submitting a complete and accurate application.' },
                { title: 'Faster Registration', description: 'Ensure a faster FSSAI registration process with expert support.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Simplify Your FSSAI Application?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Simplify your FSSAI application. Partner with [Your Company Name] for professional drafting services to ensure compliance and streamline your registration process.
              </p>
              <Link
                href="/contact-us"
