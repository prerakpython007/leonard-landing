  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Obtain your 14-digit FSSAI license number effortlessly. Ensure compliance for your food business in India with our expert FSSAI registration services."
        />
        <meta
          name="keywords"
          content="14-digit FSSAI license, FSSAI registration, food license India, FSSAI compliance services"
        />
        <title>14-Digit FSSAI License | Obtain Your Food License Easily</title>
      ...
      <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[50px] sm:rounded-b-[100px] md:rounded-b-[170px] font-montserrat overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  <span className="text-black">Effortless FSSAI</span>{' '}
                ...
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  The 14-digit FSSAI license number is mandatory for all food businesses in India, providing details about your
                  business’s registration status, state, and more. At [Your Company Name], we simplify the process of obtaining your
                  14-digit FSSAI license, ensuring compliance with the Food Safety and Standards Act, 2006.
                </p>
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-black">License Services</span>
              </h2>
            </div>
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-[#F7F7F7]">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                <span className="text-[#222831]">Benefits of a</span>{' '}
                <span className="text-black">14-Digit FSSAI License</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Gain Customer Trust', description: 'Build confidence with a verified FSSAI license number.' },
                { title: 'Ensure Compliance', description: 'Meet mandatory food safety regulations with ease.' },
                { title: 'Avoid Penalties', description: 'Operate legally in the food industry to avoid fines.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-black" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-black" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Obtain Your FSSAI License?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Obtain your 14-digit FSSAI license effortlessly. Partner with [Your Company Name] for expert FSSAI registration
                services to ensure compliance and start your food business with confidence.
              </p>
              <Link
                href="/contact-us"
