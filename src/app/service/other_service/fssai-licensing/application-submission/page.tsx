...
const submissionInfo: SubmissionInfo[] = [
  {
    id: 1,
    title: 'FoSCoS Portal Handling',
    description: 'We manage submissions through the FSSAI FoSCoS portal.',
    category: 'Portal Management',
    detailedContent: `
      • Navigate the FSSAI Food Safety Compliance System (FoSCoS) portal on your behalf.
      • Handle account creation, login, and form selection for Basic, State, or Central registration.
      • Ensure accurate entry of business details and registration type.
      • Troubleshoot technical issues during submission.
      • Provide guidance on portal-specific requirements.
    `,
  },
  {
    id: 2,
    title: 'Document Upload',
    description: 'We ensure all required documents are uploaded correctly.',
    category: 'Documentation',
    detailedContent: `
      • Compile and upload all necessary documents, including identity proofs, business certificates, and premises proof.
      • Verify document formats and sizes as per FoSCoS portal requirements.
      • Organize documents for seamless submission, reducing rejection risks.
      • Address any document-related queries from FSSAI authorities.
      • Ensure compliance with FSSAI documentation guidelines.
    `,
  },
  {
    id: 3,
    title: 'Fee Payment',
    description: 'We assist with secure online payment of FSSAI registration fees.',
    category: 'Payment Support',
    detailedContent: `
      • Guide you through the secure payment process on the FoSCoS portal.
      • Verify applicable fees based on your registration type (Basic, State, or Central).
      • Ensure payments are processed correctly to avoid delays.
      • Provide confirmation of payment submission to FSSAI.
      • Assist with resolving any payment-related issues.
    `,
  },
];

export default function FSSAIOnlineApplicationSubmissionPage() {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Seamless FSSAI online application submission for Central, State, or Basic Registration. Ensure compliance for your food business in India with our expert services."
        />
        <meta
          name="keywords"
          content="FSSAI online application submission, FSSAI registration online, food license submission, FSSAI compliance India"
        />
        <title>FSSAI Online Application Submission | Seamless Process for Registration</title>
        ...
        >
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#222831] relative inline-block tracking-tight">
              FSSAI Online Application Submission
            ...
            <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl text-[#393E46]/80 max-w-md sm:max-w-lg md:max-w-2xl mx-auto font-light">
              Seamless Process for Registration
            </p>
          </motion.div>
        </motion.section>
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  <span className="text-[#00ADB5]">Seamless</span>{' '}
                  <span className="text-[#393E46]">FSSAI Online Application Submission</span>
                </h2>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed">
                  Submitting your FSSAI application online can be complex, but we make it easy. At [Your Company Name], we handle the online submission process for Central, State, or Basic FSSAI registration, ensuring a hassle-free experience for your food business in India.
                </p>
                <p className="text-[#393E46] text-sm sm:text-base md:text-lg font-medium">
                  ...
                  to submit your FSSAI application seamlessly today.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                <span className="text-[#222831]">Our Online</span>{' '}
                <span className="text-[#00ADB5]">Submission Services</span>
              </h2>
            </div>
          ...
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                ...
                <span className="text-[#00ADB5]">Online Submission</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-6 md:px-8">
              {[
                { title: 'Save Time', description: 'Save time with a streamlined online application process.' },
                { title: 'Avoid Errors', description: 'Avoid errors with expert handling of the FoSCoS portal.' },
                { title: 'Faster Registration', description: 'Ensure timely submission for faster FSSAI registration.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Submit Your FSSAI Application Seamlessly?</h2>
              <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
                Ensure compliance with a hassle-free online submission process. Partner with [Your Company Name] to streamline your FSSAI registration.
              </p>
              <Link
                href="/contact-us"
