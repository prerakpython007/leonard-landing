...
const advisoryInfo: AdvisoryInfo[] = [
  {
    ...
    description: 'Data protection laws like GDPR, CCPA, and India’s DPDP Act regulate how organizations handle personal data, requiring compliance to avoid penalties.',
    category: 'Regulatory Basics',
    detailedContent: `
      • GDPR governs data protection for EU residents.
      • CCPA provides privacy rights for California residents.
      • DPDP Act sets India’s framework for personal data protection.
      • Laws mandate transparency, consent, and data security.
  ...
  },
  {
    ...
    detailedContent: `
      • Simplifies understanding of complex legal requirements.
      • Reduces risk of fines and legal challenges.
      • Ensures compliance with global and local laws.
      • Enhances customer trust through lawful practices.
      • Supports scalability in regulated industries.
      • Provides tailored strategies for compliance.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Conduct gap analysis of current data practices.
      • Develop tailored compliance roadmaps.
      • Advise on data subject rights and consent mechanisms.
      • Guide on cross-border data transfer compliance.
      • Support implementation of security measures.
      • Provide training on regulatory obligations.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Monitor updates to data protection laws.
  ...
  },
  {
    ...
    detailedContent: `
      ...
      • DPDP Act compliance for India’s data framework.
      • Address regional nuances in data protection laws.
      • Ensure lawful cross-border data transfers.
      • Align with industry-specific regulations (e.g., healthcare, finance).
    `,
  },
];
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-[#393E46] text-lg leading-relaxed">
                At Leonard Corporate Solutions, we provide expert regulatory advisory services to help businesses navigate complex data protection laws like GDPR, CCPA, and India’s DPDP Act. Our tailored guidance ensures compliance, mitigates risks, and supports startups, enterprises, and entrepreneurs in building trust through lawful data practices.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-[#393E46] text-lg leading-relaxed mb-6">
              Ensure compliance with complex data protection laws through Leonard Corporate Solutions’ expert regulatory advisory services. Start today to safeguard your business and build trust.
            </p>
            <a
              href="/contact-us"
