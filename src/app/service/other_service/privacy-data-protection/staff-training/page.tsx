...
const trainingInfo: TrainingInfo[] = [
  {
    ...
    description: 'Train staff on key data protection laws like GDPR, CCPA, and India’s DPDP Act to ensure compliance and awareness.',
    category: 'Legal Basics',
    detailedContent: `
      • GDPR: Protects EU residents’ data with strict consent and transparency rules.
      • CCPA: Grants California residents rights over their personal data.
      • DPDP Act: Regulates data handling in India with focus on user consent.
      • Covers data subject rights (e.g., access, deletion).
      • Emphasizes penalties for non-compliance.
      • Includes practical examples for workplace application.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      ...
      • Reduces risk of data breaches due to human error.
      • Builds a compliance-focused workplace culture.
      • Supports lawful data handling across departments.
      • Improves customer trust through staff accountability.
      • Aligns with regulatory training mandates.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Executive training: Focus on strategic compliance and risk management.
      • Technical staff: Covers secure data handling and system protocols.
      • Frontline employees: Emphasizes customer data protection practices.
      • Includes role-specific scenarios and case studies.
      • Offers interactive sessions and Q&A for engagement.
      • Provides certifications for completed training.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Regular refresher courses on regulatory changes.
      • Updates on GDPR, CCPA, DPDP Act, and other laws.
      • Conducts periodic compliance quizzes and assessments.
      • Provides resources like handbooks and quick-reference guides.
      • Offers virtual and in-person training options.
      • Tracks training completion for audit purposes.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Covers GDPR for EU operations.
      • Addresses CCPA for US-based customers.
      • Includes DPDP Act for India-based staff.
      • Trains on cross-border data transfer rules.
      • Tailors content to regional compliance needs.
      • Ensures consistency in global data practices.
    `,
  },
];
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-[#393E46] text-lg leading-relaxed">
                At Leonard Corporate Solutions, we deliver tailored staff training workshops to ensure all levels of your organization understand and comply with data protection laws like GDPR, CCPA, and India’s DPDP Act. Our programs foster a culture of compliance, reduce risks, and enhance customer trust.
              </p>
