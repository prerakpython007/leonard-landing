...
const trainingInfo: TrainingInfo[] = [
  {
    ...
    description: 'We design training specific to your business and industry.',
    category: 'Tailoring',
    detailedContent: `
      • Develop training programs tailored to your business model and data practices.
      • Customize content for specific industries like e-commerce, healthcare, or finance.
      • Address the unique compliance needs of your organization.
      • Adapt training for different staff roles, from executives to frontline employees.
      • Provide flexible delivery options, including in-person and virtual sessions.
    `,
  },
  {
    id: 2,
    title: 'Key Topics',
    description: 'We cover GDPR, DPDP, data security, and privacy best practices.',
    category: 'Education',
    detailedContent: `
      • Educate staff on GDPR, DPDP Act 2023, and other data protection laws.
      • Cover data security practices, including encryption and access controls.
      • Teach privacy best practices for handling customer and employee data.
      • Address data breach response and reporting obligations.
      • Include case studies to illustrate compliance in real-world scenarios.
    `,
  },
  {
    id: 3,
    title: 'Interactive Sessions',
    description: 'We engage staff with practical scenarios and Q&A sessions.',
    category: 'Engagement',
    detailedContent: `
      • Deliver interactive workshops with real-world scenarios and role-playing.
      • Facilitate Q&A sessions to address staff questions and concerns.
      • Use quizzes and exercises to reinforce learning and retention.
      • Provide practical tools and checklists for daily compliance tasks.
      • Ensure sessions are engaging to foster a culture of compliance.
    `,
  },
];
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Deliver tailored data protection training workshops for all staff levels with Leonard Corporate Solutions. Ensure compliance awareness in India and globally."
        />
        <meta
          name="keywords"
          content="data protection staff training, compliance awareness training, data protection workshops, business privacy training"
        />
        <title>Data Protection Staff Training | Leonard Corporate Solutions</title>
          ...
          <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">
                  <span className="text-[#00ADB5]">Ensure Compliance</span>{' '}
                  <span className="text-[#222831]">with Staff Training Workshops</span>
                </h2>
                <p className="text-[#393E46] text-base sm:text-lg leading-relaxed">
                  Compliance starts with an informed workforce. At Leonard Corporate Solutions, we deliver tailored data protection training workshops for all staff levels, ensuring your team understands and adheres to privacy regulations in India and worldwide.
                </p>
            ...
            <div className="space-y-6 sm:space-y-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
                <span className="text-[#222831]">Our Training</span>{' '}
                <span className="text-[#00ADB5]">Workshop Services</span>
              </h2>
            ...
            >
              <div className="relative py-8 sm:py-12">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  <span className="text-[#00ADB5]">Ready to Educate</span>{' '}
                  <span className="text-[#222831]">Your Staff on Data Protection?</span>
                </h2>
                <ul className="space-y-4 list-none pl-5 mb-6 text-[#393E46] text-sm sm:text-base">
                  <li className="relative pl-6 before:content-['✦'] before:absolute before:left-0 before:text-[#00ADB5]">
                    Reduce compliance violations with an educated workforce
                  </li>
                  <li className="relative pl-6 before:content-['✦'] before:absolute before:left-0 before:text-[#00ADB5]">
                    Protect your business by ensuring staff handle data responsibly
                  </li>
                  <li className="relative pl-6 before:content-['✦'] before:absolute before:left-0 before:text-[#00ADB5]">
