  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Craft comprehensive privacy policies tailored to your business. Ensure compliance with data protection laws in India and globally with Leonard Corporate Solutions."
        />
        <meta
          name="keywords"
          content="privacy policy drafting, tailored privacy policies, data protection compliance, business privacy policies"
        />
        <title>Privacy Policy Drafting Services | Leonard Corporate Solutions</title>
          ...
          <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
            ...
            >
              ...
              <div className="text-center space-y-4 sm:space-y-6">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">
                  <span className="text-black">Craft Tailored</span>{' '}
                  <span className="text-[#222831]">Privacy Policies for Compliance</span>
                </h2>
                <p className="text-[#393E46] text-base sm:text-lg leading-relaxed">
                  A robust privacy policy is essential to build trust and ensure compliance with data protection laws. At Leonard Corporate Solutions, we craft comprehensive privacy policies tailored to your business, ensuring adherence to regulations in India and internationally.
                </p>
            ...
            <div className="space-y-6 sm:space-y-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
                ...
                <span className="text-black">Policy Services</span>
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
                {policyInfo.map((info, index) => (
                  <motion.div
                    key={info.id}
            ...
            >
              <div className="relative py-8 sm:py-12">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                  ...
                  <span className="text-[#222831]">Your Business with a Tailored Privacy Policy?</span>
                </h2>
                <ul className="space-y-4 list-none pl-5 mb-6 text-[#393E46] text-sm sm:text-base">
                  ...
                  <li className="relative pl-6 before:content-['✩'] before:absolute before:left-0 before:text-black">
                    Avoid penalties by complying with data protection regulations
                  </li>
                  <li className="relative pl-6 before:content-['✩'] before:absolute before:left-0 before:text-black">
                    Protect your business from legal risks and liabilities
                  </li>
                </ul>
                <Link
                  href="/contact-us"
