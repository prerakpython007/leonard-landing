...
const advisoryInfo: AdvisoryInfo[] = [
  {
    ...
    detailedContent: `
      • Draft clear, enforceable IT outsourcing agreements.
      • Ensure compliance with industry standards and regulations.
      • Address key clauses: scope, deliverables, SLAs, and penalties.
      • Mitigate risks through precise liability and indemnity terms.
      • Align contracts with client and supplier expectations.
      • Review existing contracts for gaps and improvements.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Prevents costly disputes through clear contract terms.
      • Protects against financial risks in supplier commitments.
      • Ensures compliance with data protection and IP laws.
      • Balances risk allocation between parties.
      • Enhances negotiation outcomes with larger clients.
      • Builds trust with robust, fair agreements.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Analyze business goals and outsourcing scope.
      • Develop contracts for specific IT services (e.g., cloud, SaaS).
      • Include provisions for data security and compliance.
      • Address multi-jurisdictional legal requirements.
      • Provide templates for recurring outsourcing needs.
      • Offer ongoing support for contract updates.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Monitor regulatory changes affecting outsourcing.
      • Update contracts to align with new laws (e.g., GDPR, DPDP Act).
      • Conduct periodic contract audits for compliance.
      • Provide advice on contract renewals and terminations.
      • Support dispute resolution and renegotiations.
      • Ensure contracts remain commercially viable.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Align contracts with international laws (e.g., GDPR, CCPA).
      ...
      • Mitigate risks in global supplier relationships.
      • Support compliance with industry-specific standards.
    `,
  },
];
