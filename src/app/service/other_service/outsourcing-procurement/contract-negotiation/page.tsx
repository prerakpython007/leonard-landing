...
const negotiationInfo: NegotiationInfo[] = [
  {
    ...
    detailedContent: `
      • Develop tailored negotiation strategies for your business.
      • Identify key leverage points to balance power dynamics.
      • Focus on critical contract terms: pricing, deliverables, and timelines.
      • Prepare for high-stakes discussions with larger firms.
      • Use data-driven insights to strengthen your position.
      • Ensure agreements align with long-term business goals.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Counter unequal bargaining power with larger companies.
      • Protect against unfavorable terms and hidden risks.
      • Secure fair pricing and deliverable commitments.
      • Avoid disputes through clear, balanced agreements.
      • Build confidence in high-pressure negotiations.
      • Enhance outcomes with expert legal guidance.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Analyze contract scope and negotiation objectives.
      • Tailor strategies for IT, outsourcing, or supplier contracts.
      • Address industry-specific needs (e.g., finance, tech).
      • Prepare for multi-party or international negotiations.
      • Provide real-time support during negotiation meetings.
      • Offer post-negotiation contract review and refinement.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Support contract renewals with updated terms.
      • Advise on amendments to reflect changing needs.
      • Monitor market trends to inform negotiation strategies.
      • Provide training for in-house teams on negotiation best practices.
      • Assist with dispute resolution during negotiations.
      • Ensure long-term contract alignment with business goals.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Align negotiations with international regulations (e.g., GDPR, CCPA).
      • Address cross-border contract complexities.
      • Account for cultural and legal differences in global markets.
      • Secure fair terms in multi-jurisdictional agreements.
      • Mitigate risks in international supplier relationships.
      • Ensure compliance with industry-specific global standards.
    `,
  },
];
