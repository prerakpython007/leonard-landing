...
const complianceInfo: ComplianceInfo[] = [
  {
    ...
    detailedContent: `
      • Align contracts with public sector regulations (e.g., FAR, EU Procurement Directives).
      • Ensure transparency in bidding and contract award processes.
      • Address anti-corruption and ethical procurement standards.
      • Include audit clauses for regulatory oversight.
      • Mitigate risks of non-compliance penalties.
      • Draft provisions for mandatory reporting and disclosures.
    `,
  },
  {
    id: 2,
    ...
    detailedContent: `
      • Conduct due diligence on suppliers for financial and ethical stability.
      • Include clauses for liability limits and indemnification.
      • Structure contracts to manage budget and scope risks.
      • Add termination rights for non-compliance or underperformance.
      • Mitigate risks from regulatory changes.
      • Ensure robust dispute resolution mechanisms.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Develop contracts for specific public sector needs (e.g., IT, infrastructure).
      • Include provisions for transparency and accountability.
      • Address multi-jurisdictional regulatory requirements.
      • Ensure compliance with public sector budgeting constraints.
      • Incorporate performance-based SLAs and penalties.
      • Provide templates for recurring procurement needs.
    `,
  },
  {
    id: 4,
    ...
    detailedContent: `
      • Establish KPIs for supplier compliance and performance.
      • Conduct regular audits for regulatory and ethical adherence.
      • Monitor anti-corruption and fair practice compliance.
      • Implement escalation processes for non-compliance issues.
      • Use performance bonds for high-risk suppliers.
      • Ensure deliverables meet public sector standards.
    `,
  },
  {
    id: 5,
    ...
    detailedContent: `
      • Align contracts with international procurement laws (e.g., WTO GPA).
      • Address cross-border transparency and anti-corruption standards.
      • Mitigate risks from geopolitical and regulatory shifts.
      • Draft multi-jurisdictional procurement agreements.
      • Ensure compliance with local public sector regulations.
      • Support supplier selection in global markets.
    `,
  },
];
