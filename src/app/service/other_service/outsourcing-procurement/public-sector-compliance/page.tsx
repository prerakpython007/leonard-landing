      ...
      <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[170px] font-montserrat overflow-hidden">
            ...
            >
              ...
              <div className="text-center space-y-6">
                <h2 className="text-4xl font-bold mb-4">
                  ...
                  <span className="text-[#393E46]">Procurement Regulations</span>
                </h2>
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Outsourcing for the public sector involves strict procurement regulations that can be challenging to navigate. At [Your Company Name], we provide expert legal services to ensure your outsourcing contracts comply with public sector requirements in India and internationally.
                </p>
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-4 md:px-16">
              {publicSectorComplianceInfo.map((info: PublicSectorComplianceInfo, index: number) => (
                <motion.div
                  key={info.id}
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24 bg-[#F7F7F7]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-4 md:px-16">
              {[
                { title: 'Avoid Penalties', description: 'Avoid penalties by meeting public sector procurement regulations.' },
                { title: 'Win Contracts', description: 'Win public sector contracts with compliant outsourcing agreements.' },
                { title: 'Build Trust', description: 'Build trust with public sector clients through legal adherence.' },
              ].map((benefit, index) => (
                <motion.div
                  key={benefit.title}
        ...
        <section className="py-32 px-4 md:px-16 lg:px-24">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 w-8 h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-8 -right-8 w-8 h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-4xl font-bold mb-4">Ready to Ensure Public Sector Compliance?</h2>
              <p className="text-[#393E46] text-lg leading-relaxed mb-6">
                Navigate complex procurement regulations with expert legal services. Partner with [Your Company Name] for compliant outsourcing contracts.
              </p>
              <Link
                href="/contact-us"
