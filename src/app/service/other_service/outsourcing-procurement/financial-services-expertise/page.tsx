...
const financialServicesInfo: FinancialServicesInfo[] = [
  {
    ...
    detailedContent: `
      • Ensure outsourcing contracts meet RBI, SEC, and FCA regulations.
      • Conduct compliance audits to identify regulatory gaps.
      • Provide guidance on aligning contracts with financial laws.
      • Support documentation for regulatory approvals.
      • Monitor ongoing compliance with evolving regulations.
    `,
    icon: FileCheck,
  },
  {
    ...
    detailedContent: `
      • Implement robust data protection measures for financial data.
      • Ensure compliance with GDPR, DPDP, and other data laws.
      • Advise on encryption and secure data transfer protocols.
      • Mitigate risks of data breaches in outsourcing agreements.
      • Develop data security clauses tailored to financial services.
    `,
    icon: Lock,
  },
  {
    ...
    detailedContent: `
      • Draft customized contracts for financial outsourcing.
      • Include clauses to address sector-specific risks.
      • Ensure contracts protect sensitive financial data.
      • Align contract terms with regulatory requirements.
      • Provide scalable contract solutions for future needs.
    `,
    icon: Shield,
  },
];
          ...
          <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
            ...
            >
              ...
              <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">
                  <span className="text-black">Specialized Advice</span>{' '}
                  <span className="text-[#222831]">for Financial Sector Outsourcing</span>
                </h2>
                <p className="text-base sm:text-lg leading-relaxed">
                  Outsourcing in the financial sector comes with unique regulatory and operational challenges. At Leonard Corporate Solutions, we provide specialized legal advice tailored to financial services outsourcing, ensuring compliance and security in India and worldwide.
                </p>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
                {financialServicesInfo.map((info, index) => (
                  <motion.div
                    key={info.id}
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
                ...
                <span className="text-black">Financial Services Expertise</span>
              </h2>
              <ul className="space-y-4 list-none pl-5">
                {[
                  'Ensure compliance with strict financial sector regulations',
                  'Protect sensitive financial data during outsourcing',
                  'Mitigate risks unique to financial services outsourcing',
                ].map((benefit, index) => (
            ...
            >
              <div className="relative py-8 sm:py-12">
                ...
                <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-black" />
                <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-black" />
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Secure Your Financial Outsourcing?</h2>
                <p className="text-[#393E46] text-sm sm:text-lg leading-relaxed mb-6">
                  Ensure compliance and security with specialized financial outsourcing expertise. Partner with Leonard Corporate Solutions today.
                </p>
                <Link
                  href="/contact-us"
