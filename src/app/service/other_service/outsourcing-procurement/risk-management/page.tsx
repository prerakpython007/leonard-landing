...
const riskManagementInfo: RiskManagementInfo[] = [
  {
    ...
    detailedContent: `
      • Conduct thorough assessments of outsourcing contract terms.
      • Identify financial risks such as penalties or cost overruns.
      • Analyze supplier performance risks and dependencies.
      • Provide detailed risk reports for informed decision-making.
      • Align assessments with your business priorities.
    `,
    icon: AlertTriangle,
  },
  {
    ...
    detailedContent: `
      • Develop tailored strategies to minimize financial risks.
      • Address penalty clauses to reduce potential liabilities.
      • Optimize service-level agreements (SLAs) for clarity and fairness.
      • Implement contingency plans for supplier non-performance.
      • Ensure strategies align with operational and financial goals.
    `,
    icon: Shield,
  },
  {
    ...
    detailedContent: `
      • Continuously monitor supplier contract performance.
      • Identify emerging risks through regular reviews.
      • Provide actionable insights to address performance gaps.
      • Ensure compliance with contract terms and SLAs.
      • Support proactive adjustments to mitigate new risks.
    `,
    icon: Monitor,
  },
];
    ...
    <>
      ...
      <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[50px] sm:rounded-b-[100px] md:rounded-b-[170px] font-montserrat overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        {showPopup && selectedInfo && (
          ...
          >
            <motion.div
              className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6 sm:p-8 md:p-10 shadow-xl border border-black/20 relative"
            ...
            >
              ...
              <button
                onClick={closePopup}
                className="absolute top-4 right-4 p-2 text-[#393E46] hover:text-black hover:bg-black/10 rounded-full focus:outline-none"
              ...
              <div className="text-[#393E46]/85 text-sm sm:text-base leading-relaxed">
                {selectedInfo.detailedContent.split('\n').map((line: string, index: number) => {
                  ...
                  if (!line) return null;
                  return (
                    <p key={index} className="mb-2 relative pl-6 before:content-['✦'] before:absolute before:left-0 before:text-black">
        ...
        <motion.section className="relative min-h-[50vh] sm:min-h-[60vh] md:min-h-[80vh] flex items-center justify-center px-4">
          <div className="absolute top-4 left-4 w-8 sm:top-6 sm:left-6 sm:w-10 sm:h-10 md:top-8 md:left-8 md:w-12 md:h-12 border-t-2 border-l-2 border-black hidden lg:block" />
          <div className="absolute top-4 right-4 w-8 sm:top-6 sm:right-6 sm:w-10 sm:h-10 md:top-8 md:right-8 md:w-12 md:h-12 border-t-2 border-r-2 border-black hidden lg:block" />
          <div className="absolute bottom-4 left-4 w-8 sm:bottom-6 sm:left-6 sm:w-10 sm:h-10 md:bottom-8 md:left-8 md:w-12 md:h-12 border-b-2 border-l-2 border-black hidden lg:block" />
          <div className="absolute bottom-4 right-4 w-8 sm:bottom-6 sm:right-6 sm:w-10 sm:h-10 md:bottom-8 md:right-8 md:w-12 md:h-12 border-b-2 border-r-2 border-black hidden lg:block" />
          <motion.div
            initial={{ scale: 0.9, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
          ...
          <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
            ...
            >
              ...
              <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">
                  <span className="text-black">Minimize Financial</span>{' '}
            ...
            <div className="space-y-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
                ...
                <span className="text-black">Management Services</span>
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
                {riskManagementInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="px-3 py-1 text-xs font-medium bg-black/10 text-black rounded-full w-fit mb-3">
                      {info.category}
                    </div>
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
                ...
                <span className="text-black">Risk Management</span>
              </h2>
