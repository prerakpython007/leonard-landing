...
import { Shield, Search, Globe, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for Brand Protection service info
interface BrandServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const brandServices = [
  {
    ...
    category: "Monitoring",
    detailedContent: `• Continuous monitoring of domain registrations worldwide
• Detection of potentially infringing domain names
• Alert system for suspicious domain activity
• Comprehensive reporting on potential threats
• Monitoring across all major TLDs and ccTLDs
• Regular updates on domain registration trends`
  },
  {
    icon: Shield,
    ...
    category: "Legal",
    detailedContent: `• Drafting and sending cease and desist letters
• Professional communication with infringing parties
• Legal basis for trademark infringement claims
• Negotiation for voluntary domain transfers
• Documentation for potential legal proceedings
• Follow-up on compliance with demands`
  },
  {
    icon: Globe,
    title: 'Global Reach',
    ...
    detailedContent: `• Protection across global jurisdictions
• Knowledge of international trademark laws
• Coordination with local legal experts worldwide
• Management of cross-border brand protection
• Understanding of regional domain policies
• Multi-lingual communication capabilities`
  }
];

const benefits = [
  'Protect your brand identity with comprehensive monitoring and enforcement',
  'Prevent unauthorized use of your trademarks in domain names',
  'Global coverage ensures protection across all jurisdictions',
];

export default function BrandProtectionPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<BrandServiceInfo | null>(null);

  const handleExploreClick = (info: BrandServiceInfo) => {
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Comprehensive Solutions to Protect Your Brand Identity
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in comprehensive brand protection services to safeguard your intellectual property from domain name misuse. Your brand's online identity is critical in today's digital landscape.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our brand protection services include domain monitoring, cease and desist actions, and global enforcement to ensure your trademarks remain secure across all jurisdictions and domain extensions.
                    </p>
                    <p className="text-base md:text-lg font-medium text-[#393E46]">
                      📩 For expert brand protection services:{" "}
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Brand Protection visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our brand protection services ensure your trademarks are safeguarded with comprehensive monitoring and enforcement strategies.
              </p>
              <Link
                href="/contact"
