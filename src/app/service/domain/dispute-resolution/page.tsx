...
import { FileCheck, Shield, Scale, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for Dispute Resolution service info
interface DisputeServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const disputeServices = [
  {
    icon: FileCheck,
    title: 'UDRP/INDRP Filings',
    description: 'We handle domain dispute filings under UDRP and INDRP policies.',
    ...
    category: "Filings",
    detailedContent: `• Expert handling of UDRP (Uniform Domain-Name Dispute-Resolution Policy) cases
• Specialized INDRP (IN Domain Name Dispute Resolution Policy) filings for .in domains
• Comprehensive evidence collection and documentation
• Professional drafting of complaints and responses
• Coordination with dispute resolution providers
• Management of case timelines and deadlines`
  },
  {
    icon: Scale,
    title: 'Negotiation & Mediation',
    description: 'We explore amicable resolutions to avoid lengthy proceedings.',
    ...
    category: "Resolution",
    detailedContent: `• Strategic negotiation with domain name holders
• Professional mediation services for dispute resolution
• Development of settlement agreements
• Assistance with domain transfer arrangements
• Cost-effective alternatives to formal proceedings
• Preservation of business relationships through amicable solutions`
  },
  {
    icon: Shield,
    title: 'Fast-Track Recovery',
    description: 'Our expertise ensures quick recovery of disputed domain names.',
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    category: "Recovery",
    detailedContent: `• Expedited domain name recovery procedures
• Strategic approach to maximize success rates
• Monitoring of disputed domain names
• Enforcement of dispute resolution outcomes
• Assistance with domain transfer implementation
• Prevention of future disputes through proactive measures`
  }
];

const benefits = [
  'Protect your brand identity with expert domain dispute resolution services',
  "Recover valuable domain assets efficiently with our specialized expertise",
  'Navigate complex domain dispute procedures with professional guidance',
];

export default function DisputeResolutionPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<DisputeServiceInfo | null>(null);

  const handleExploreClick = (info: DisputeServiceInfo) => {
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Domain Dispute Resolution hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert Solutions for Domain Name Disputes and Recovery
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in domain dispute resolution, helping you reclaim your domain names efficiently. Whether it's a case of cybersquatting or trademark infringement, our streamlined and cost-effective procedures ensure your intellectual property is protected.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our domain dispute resolution services include UDRP/INDRP filings, negotiation and mediation services, and fast-track domain recovery to ensure your brand's online presence is secure and protected against unauthorized use.
                    </p>
                    <p className="text-base md:text-lg font-medium text-[#393E46]">
                      📩 For expert domain dispute resolution:{" "}
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1563013541-3f7e7bca69a6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Domain Dispute Resolution visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our domain dispute resolution services ensure your online brand presence is protected with expert guidance and efficient recovery procedures.
              </p>
              <Link
                href="/contact"
