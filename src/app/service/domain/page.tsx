        ...
        <div className="max-w-6xl mx-auto relative">
            ...
            <div className="relative max-w-3xl mx-auto px-8">
              ...
              <div className="text-center space-y-6">
                <h2 className="text-4xl font-bold mb-4 relative inline-block">
                  ...
                  <span className="text-[#393E46]">Law Overview</span>
                </h2>
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Domain names are a critical component of your intellectual property portfolio. Disputes over domain names
                  require swift and efficient resolution. Since the late 1990s, streamlined procedures have replaced lengthy
                  court proceedings, offering cost-effective and self-enforcing solutions to tackle infringements globally.
                </p>
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Our experienced team, having represented both claimants and defendants, provides strategic and balanced
                  advice to protect your brand and resolve disputes effectively.
                </p>
                <p className="text-[#393E46] text-lg font-medium">
                  📩 Need expert assistance? Reach out at{' '}
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#222831]">Our Domain Name</span>{' '}
          ...
          >
            <div className="relative py-12">
              ...
              <p className="text-[#393E46] text-lg text-center leading-relaxed">
                At Leonard Corporate Solutions, we protect your digital identity with precision and expertise. Our domain name
                law services are designed to evolve with your business, ensuring robust protection and swift dispute resolution
                worldwide.
              </p>
            </div>
          </motion.div>
