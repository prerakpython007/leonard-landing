...
import { Gavel, FileText, Search, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for Litigation Support service info
interface LitigationServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const litigationServices = [
  {
    ...
    category: "Legal",
    detailedContent: `• Experienced legal representation in domain-related lawsuits
• Specialization in intellectual property and domain name disputes
• Court appearances and proceedings management
• Preparation of legal documents and pleadings
• Coordination with local counsel in different jurisdictions
• Strategic advocacy for your domain rights`
  },
  {
    icon: FileText,
    title: 'Case Strategy',
    ...
    category: "Strategy",
    detailedContent: `• Comprehensive case analysis and evaluation
• Development of tailored litigation strategies
• Assessment of legal merits and potential outcomes
• Cost-benefit analysis of litigation options
• Timeline management for legal proceedings
• Coordination with expert witnesses when needed`
  },
  {
    icon: Search,
    ...
    category: "Evidence",
    detailedContent: `• Comprehensive evidence collection and documentation
• Trademark registration and usage evidence compilation
• Documentation of bad faith registration and use
• Gathering of business and commercial evidence
• Preservation of digital evidence and screenshots
• Expert witness testimony preparation
• Chronological evidence organization for court presentation`
  }
];

const benefits = [
  'Expert legal representation for complex domain name disputes',
  'Strategic case development to maximize your chances of success',
  'Comprehensive evidence gathering to support your legal claims',
];

export default function LitigationSupportPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<LitigationServiceInfo | null>(null);

  const handleExploreClick = (info: LitigationServiceInfo) => {
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1563013541-3f7e7bca69a6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
            alt="Litigation Support hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert Legal Support for Complex Domain Name Disputes
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      When domain name disputes escalate to litigation, you need expert legal support. At Leonard Corporate Solutions, we provide comprehensive litigation support for complex domain name cases, ensuring your rights are protected in court proceedings.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our litigation support services include court representation, case strategy development, and evidence gathering to build strong legal cases for domain name disputes that require formal legal action.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Litigation Support visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our litigation support services ensure you have expert legal representation and strategic guidance for complex domain name disputes that require court intervention.
              </p>
              <Link
                href="/contact"
