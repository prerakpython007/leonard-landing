...
import { Shield, FileText, Gavel, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for Advocacy service info
interface AdvocacyServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
• Legal argument formulation for domain recovery
• Representation in dispute resolution proceedings
• Assistance with settlement negotiations
• Post-proceeding domain transfer support`
  },
  {
    icon: FileText,
    ...
    category: "Defense",
    detailedContent: `• Assessment of claim validity and defense strategy
• Preparation of response to allegations
• Evidence collection to support legitimate registration
• Legal argument development for domain retention
• Representation throughout dispute proceedings
• Assistance with counter-claims when appropriate`
  },
  {
    icon: Gavel,
    title: 'Procedural Expertise',
    description: 'We navigate UDRP, INDRP, and other dispute resolution processes.',
    image: "https://images.unsplash.com/photo-1604871000636-074fa5117945?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    category: "Expertise",
    detailedContent: `• Expertise in multiple dispute resolution policies (UDRP, INDRP, etc.)
• Procedural guidance through all dispute stages
• Filing and documentation according to policy requirements
• Communication with dispute resolution providers
• Timeline management for response deadlines
• Post-decision implementation support`
  }
];

const benefits = [
  'Expert representation in domain name dispute proceedings',
...
export default function AdvocacyPage() {
  ...
  const [selectedInfo, setSelectedInfo] = useState<AdvocacyServiceInfo | null>(null);

  const handleExploreClick = (info: AdvocacyServiceInfo) => {
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_DQxC_lg2rAdrQOesmoS-Y_g-TbcsMejIgQ&s"
            alt="Advocacy Services hero"
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1589391886645-d51941baf7fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Advocacy Services visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
