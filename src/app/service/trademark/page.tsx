        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="mb-12 sm:mb-16 md:mb-24">
            ...
            >
              ...
              <div className="absolute -top-6 -left-6 w-8 h-8 border-t-2 border-l-2 border-black" />
              <div className="absolute -top-6 -right-6 w-8 h-8 border-t-2 border-r-2 border-black" />
              <div className="absolute -bottom-6 -left-6 w-8 h-8 border-b-2 border-l-2 border-black" />
              <div className="absolute -bottom-6 -right-6 w-8 h-8 border-b-2 border-r-2 border-black" />

              <div className="text-center space-y-6">
                <h2 className="text-4xl font-bold mb-4">
                  <span className="text-black">Trademark</span>{' '}
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-5 relative z-10">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#222831] mb-3 group-hover:text-black transition-colors duration-300">{service.title}</h3>
