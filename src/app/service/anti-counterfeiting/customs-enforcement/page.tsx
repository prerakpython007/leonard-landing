...
import { FileCheck, Users, Shield, X } from 'lucide-react';
import Link from 'next/link';
import { useState, useCallback, useMemo, type JSX } from 'react';

// Define the interface for Customs Enforcement service info
...
// Optimized: Use WebP images where possible and proper sizes
const enforcementServices = [
  {
    ...
    image: "https://images.unsplash.com/photo-1562564055-71e051d33c19?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGxlZ2FsfGVufDB8fDB8fHww",
    category: "Registration",
    detailedContent: `• Intellectual property registration with customs authorities
• Documentation preparation for customs recordation
• Trademark and copyright verification for customs databases
• International customs registration coordination
• Renewal and maintenance of customs registrations
• Multi-jurisdictional customs protection strategy`
  },
  {
    id: 2,
    icon: Users,
    ...
    image: "https://images.unsplash.com/photo-1521791055366-0d553872125f?q=80&w=1738&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    category: "Training",
    detailedContent: `• Customized training programs for customs officials
• Product authentication workshops and materials
• Identification guides for counterfeit detection
• Regular updates on new counterfeit techniques
• On-site and virtual training sessions
• Collaboration with border protection agencies
• Multilingual training materials for international operations`
  },
  {
    id: 3,
    icon: Shield,
    ...
    image: "https://images.unsplash.com/photo-1589216532372-1c2a367900d9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjZ8fGxlZ2FsfGVufDB8fDB8fHww",
    category: "Enforcement",
    detailedContent: `• Monitoring and detection of suspicious shipments
• Coordination with customs for inspection and seizure
• Legal documentation for seizure proceedings
• Destruction coordination of counterfeit goods
• Reporting and evidence collection for legal actions
• Follow-up actions to prevent future infringements
• International seizure coordination across borders`
  }
];

const benefits = [
  'Block counterfeit goods before they reach consumers with proactive border protection',
  'Strengthen your brand\'s protection at international borders through customs collaboration',
  'Deter counterfeiters by disrupting their supply chains and increasing seizure rates',
];
...
export default function CustomsEnforcementPage() {
  ...
  const handleExploreClick = useCallback((info: EnforcementServiceInfo) => {
...
const Popup = ({ selectedInfo, onClose }: { selectedInfo: EnforcementServiceInfo; onClose: () => void }) => {
  return (
    <motion.div
  ...
  return (
    <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1453945619913-79ec89a82c51?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Customs Enforcement hero"
        ...
        >
          <div className="relative flex flex-col lg:flex-row items-center">
            ...
            >
              <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                    Our customs enforcement services include IP registration with customs, training programs for officials, and coordination of seizure operations to ensure your products are protected at international borders.
                  </p>
                  <p className="text-base md:text-lg font-medium text-[#393E46]">
                    📩 For expert customs enforcement support:{" "}
            ...
            <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
              <div className="absolute inset-0">
                <img 
                  src="https://media.istockphoto.com/id/2193579560/photo/businessman-explaining-a-concept-to-his-colleagues.webp?a=1&b=1&s=612x612&w=0&k=20&c=4TeiGwoEetez4b92EvXowRTOLrCIsmgfRCyH-00xy_o=" 
                  alt="Customs Enforcement visual" 
...
const ServiceCard = ({ service, index, onClick }: { 
  service: EnforcementServiceInfo; 
  index: number; 
  onClick: (info: EnforcementServiceInfo) => void; 
}) => {
  return (
    <motion.div
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mt-16 md:mt-24 lg:mt-32">
          <motion.h2
            ...
            // style={{ willChange: 'transform, opacity' }}
          >
            Our Customs Enforcement Services
          </motion.h2>
    ...
    >
      <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
        <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
          At Leonard Corporate Solutions, our customs enforcement services ensure your brand is protected at international borders with advanced registration, training, and seizure coordination.
        </p>
        <Link
          href="/contact"
