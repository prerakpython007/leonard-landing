  ...
  const serviceCards = [
    {
      ...
      description:
        "Identify and track counterfeit products threatening your brand using advanced techniques.",
      slug: "counterfeit-detection",
      image:
        "https://images.unsplash.com/photo-1581093588401-7b0f9b6c0b86?auto=format&fit=crop&q=80&w=1400",
      category: "Detection",
    },
    {
      icon: FileCheck,
      ...
      description:
        "Collaborate with customs authorities to seize counterfeit goods at borders.",
      slug: "customs-enforcement",
      image:
        "https://images.unsplash.com/photo-1567427018141-0584cfcbf1b3?auto=format&fit=crop&q=80&w=1400",
    ...
    },
    {
      ...
      description:
        "Pursue legal action against counterfeiters to protect your brand and reputation.",
      slug: "legal-action-support",
      image:
        "https://images.unsplash.com/photo-1581092580494-7a7d2b86a3b8?auto=format&fit=crop&q=80&w=1400",
      category: "Legal",
    },
    {
      icon: Briefcase,
      ...
      description:
        "Develop tailored strategies to proactively combat counterfeiting threats.",
      slug: "anti-counterfeiting-strategy",
      image:
        "https://images.unsplash.com/photo-1508385082359-f3d0d0a7b9d4?auto=format&fit=crop&q=80&w=1400",
      category: "Strategy",
    },
    {
      icon: FileText,
      ...
      description:
        "Strengthen your IP portfolio to enhance enforcement against counterfeiters.",
      slug: "ip-rights-advisory",
      image:
    ...
    },
    {
      ...
      description:
        "Monitor markets and online platforms to detect and address counterfeiting activities.",
      ...
      <section className="relative h-[75vh] md:h-[85vh] lg:h-[95vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light">
            Defend your brand — detection, enforcement, legal support and market monitoring.
          </p>
        </motion.div>
      </section>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            <div className="relative flex items-center flex-col lg:flex-row">
              {/* Left clipped card */}
              <div
                className="relative w-full lg:w-3/5 z-20 mb-12 lg:mb-0 lg:mr-[-120px] ml-0"
                ...
                <div className="bg-white/98 p-10" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-6">
                    ...
                    <p className="text-lg leading-relaxed text-[#393E46]">
                      Counterfeiting undermines revenue and damages reputation. Leonard Corporate Solutions provides integrated anti-counterfeiting services — from detection and market monitoring to customs collaboration and legal support.
                    </p>

                    <p className="text-lg leading-relaxed text-[#393E46]">
                      We combine field investigations, digital monitoring, customs partnerships and IP enforcement strategies to protect your products and customers.
                    </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-16">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-gray-300 max-w-2xl mx-auto">
              Detection, enforcement, legal support and monitoring tailored to your brand.
            </p>
          </div>
          ...
          >
            {filteredServices.map((service, index) => (
              <Link
                key={service.title}
                href={`/service/anti-counterfeiting/${service.slug}`}
