...
import { MessageSquare, Bell, HandshakeIcon, X } from 'lucide-react';
import Link from 'next/link';
import { useState, useCallback, useMemo, type JSX } from 'react';

// Define the interface for Investor Relations service info
interface InvestorServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
// Investor Relations services data
const investorServices = [
  {
    ...
    image: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=1760&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    category: "Communication",
    detailedContent: `• Investor communication strategy development
• Quarterly and annual report creation
• Investor newsletter drafting and distribution
• Shareholder meeting preparation and materials
• Crisis communication planning
• Investor presentation development
• FAQs and investor relations materials`
  },
  {
    id: 2,
    icon: Bell,
    ...
    category: "Compliance",
    detailedContent: `• Regulatory compliance monitoring and reporting
• Investor agreement adherence tracking
• SEBI and other regulatory body compliance
...
• Compliance audit preparation`
  },
  {
    ...
    category: "Resolution",
    detailedContent: `• Investor dispute mediation and resolution
• Shareholder agreement interpretation
• Negotiation support for investor conflicts
• Legal guidance for contentious situations
• Documentation of resolution agreements
...
const benefits = [
  'Enhanced investor trust and confidence through transparent communication',
  'Reduced legal risks with proper compliance management',
  'Stronger long-term relationships with investors and stakeholders',
];

export default function InvestorRelationsPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<InvestorServiceInfo | null>(null);

  const handleExploreClick = useCallback((info: InvestorServiceInfo) => {
...
const Popup = ({ selectedInfo, onClose }: { selectedInfo: InvestorServiceInfo; onClose: () => void }) => {
  return (
    <motion.div
  ...
  return (
    <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=1760&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            >
              <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                    Our comprehensive approach includes communication strategy development, compliance management, and conflict resolution to ensure your investor relationships remain strong, transparent, and legally compliant.
                  </p>
                  <p className="text-base md:text-lg font-medium text-[#393E46]">
                    📩 For expert investor relations support:{" "}
...
const ServiceCard = ({ service, index, onClick }: { 
  service: InvestorServiceInfo; 
  index: number; 
  onClick: (info: InvestorServiceInfo) => void; 
}) => {
  return (
    <motion.div
    ...
    >
      <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm">
        <h2 className="text-[#eeeeee] text-2xl md:text-3xl lg:text-4xl font-extrabold text-center mb-6 md:mb-8"
          ...
          Benefits of Investor Relations Support
        </h2>
    ...
    >
      <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
        <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
          At Leonard Corporate Solutions, our investor relations services ensure your communications are effective, your compliance is maintained, and your investor relationships remain strong and productive.
        </p>
        <Link
          href="/contact"
