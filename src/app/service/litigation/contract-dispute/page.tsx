...
import { FileText, Scale, Shield, Search, MessageSquare, HandshakeIcon } from 'lucide-react';
...
const features = [
	{
		...
		description: 'In-depth contract review.',
	},
	{
		icon: Scale,
		title: 'Breach Assessment',
		description: 'Contract breach evaluation.',
	},
	{
		icon: Shield,
		title: 'Rights Protection',
		description: 'Contractual rights defense.',
	},
	{
		icon: Search,
	...
	},
	{
		...
		description: 'Strategic dispute planning.',
	},
	{
		icon: HandshakeIcon,
		title: 'Negotiation Support',
		description: 'Expert negotiation guidance.',
	},
];
