...
import { Scale, Search, HandshakeIcon } from 'lucide-react';
					...
					<motion.div className="relative max-w-3xl mx-auto px-8">
						...
						<div className="text-[#393E46] space-y-6">
							<p className="text-lg leading-relaxed">
								Breaches of contract can disrupt your business and lead to financial losses. At Leonard Corporate Solutions, we provide precise legal interventions to resolve contract disputes, protecting your interests in India and internationally.
							</p>
						...
						<div className="max-w-6xl mx-auto">
							...
							>
								...
								<p className="text-[#393E46] text-lg leading-relaxed mb-6">
									Resolve contract disputes effectively. Contact us for legal support today!
								</p>
								<Link
									href="/contact-us"
