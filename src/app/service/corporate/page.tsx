...
import { Briefcase, FileText, Scale, Shield, UserCheck, Package } from 'lucide-react';
...
export default function CorporateLegalServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[170px] font-montserrat overflow-hidden">
      ...
      {/* Corporate Legal Services Information Section */}
        ...
        <div className="max-w-6xl mx-auto relative">
            ...
            <div className="relative max-w-3xl mx-auto px-8">
              ...
              <div className="text-center space-y-6">
                <h2 className="text-4xl font-bold mb-4 relative inline-block">
                  <span className="text-[#00ADB5]">Corporate Legal</span>{' '}
                  <span className="text-[#393E46]">Services Overview</span>
                </h2>
                <p className="text-[#393E46] text-lg leading-relaxed">
                  At Leonard Corporate Solutions, we provide comprehensive corporate legal services to help businesses thrive in a complex regulatory environment. From company formation to governance and compliance, our expert team delivers precise, actionable legal solutions tailored to your needs.
                </p>
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Whether you're a startup, SME, or multinational, we ensure your operations are legally sound, compliant, and positioned for growth with strategic legal support.
                </p>
                <p className="text-[#393E46] text-lg font-medium">
                  📩 Need tailored corporate legal support? Reach out at{' '}
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#222831]">Our Corporate Legal</span>{' '}
          ...
          >
            <div className="relative py-12">
              ...
              <p className="text-[#393E46] text-lg text-center leading-relaxed">
                At Leonard Corporate Solutions, our corporate legal services are designed to empower your business with clarity and confidence. We evolve with your needs, ensuring robust legal frameworks that drive success.
              </p>
            </div>
          </motion.div>
        </div>
