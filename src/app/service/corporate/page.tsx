      ...
      >
        ...
        >
          ...
          <p className="mt-8 text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Empowering Your Business with Strategic Legal Solutions
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="relative max-w-3xl mx-auto px-8">
              ...
              <div className="text-center space-y-6">
                ...
                <p className="text-[#393E46] text-lg leading-relaxed">
                  Leonard Corporate Solutions provides comprehensive corporate legal services, from company formation to governance and compliance. Our expert team delivers tailored solutions to ensure your business is legally sound and positioned for growth, regardless of size or industry.
                </p>
                <p className="text-[#393E46] text-lg font-medium">
                  ...
                  for tailored corporate legal support.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#222831]">Our Corporate</span>{' '}
          ...
          >
            <div className="relative py-12">
              ...
              <p className="text-[#393E46] text-lg text-center leading-relaxed">
                Leonard Corporate Solutions empowers your business with tailored corporate legal services, ensuring clarity, compliance, and confidence for sustainable growth.
              </p>
            </div>
          </motion.div>
        </div>
