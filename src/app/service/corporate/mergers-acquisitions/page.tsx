...
// Define the interface for M&A service info
interface MAServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const maServices = [
  {
    ...
    category: "Analysis",
    detailedContent: `• Comprehensive legal and financial due diligence
...
• Tax implications assessment`
  },
  {
    ...
    detailedContent: `• Drafting and reviewing transaction documents
• Letter of Intent (LOI) preparation
• Share Purchase Agreement (SPA) drafting
• Asset Purchase Agreement (APA) preparation
...
• Closing documentation preparation`
  },
  {
    ...
    detailedContent: `• Post-merger integration planning
...
export default function MergersAcquisitionsPage() {
  ...
  const [selectedInfo, setSelectedInfo] = useState<MAServiceInfo | null>(null);

  const handleExploreClick = useCallback((info: MAServiceInfo) => {
...
const Popup = ({ selectedInfo, onClose }: { selectedInfo: MAServiceInfo; onClose: () => void }) => {
  return (
    <motion.div
  ...
  return (
    <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Mergers & Acquisitions hero"
        ...
        >
          <div className="relative flex flex-col lg:flex-row items-center">
            ...
            >
              <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                    Our comprehensive approach includes due diligence, transaction support, and integration assistance to ensure your M&A activities are successful and create long-term value.
                  </p>
                  <p className="text-base md:text-lg font-medium text-[#393E46]">
                    📩 For expert M&A support:{" "}
            ...
            <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
              <div className="absolute inset-0">
                <img 
                  src="https://images.unsplash.com/photo-1553413077-190dd305871c?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                  alt="Mergers & Acquisitions visual" 
...
const ServiceCard = ({ service, index, onClick }: { 
  service: MAServiceInfo; 
  index: number; 
  onClick: (info: MAServiceInfo) => void; 
}) => {
  return (
    <motion.div
    ...
    >
      <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
        <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
          At Leonard Corporate Solutions, our M&A services ensure your transactions are handled with expertise, from due diligence to integration, maximizing value and minimizing risks.
        </p>
        <Link
          href="/contact"
