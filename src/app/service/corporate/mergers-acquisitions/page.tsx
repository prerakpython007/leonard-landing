        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831]">
                <span className="text-[#00ADB5]">Navigate</span> M&A with Confidence
              </h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Our M&A</span> <span className="text-[#00ADB5]">Services</span>
            </h2>
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Benefits of</span> <span className="text-[#00ADB5]">M&A Support</span>
            </h2>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
              <span className="text-[#00ADB5]">Navigate</span> M&A with Expert Support
            </h2>
            ...
            <Link
              ...
              aria-label="Contact us for M&A services"
            >
              Contact Us
