        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831]">
                <span className="text-[#00ADB5]">Strengthen Your</span> Governance Framework
              </h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Our Governance</span> <span className="text-[#00ADB5]">Services</span>
            </h2>
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Why Governance</span> <span className="text-[#00ADB5]">Matters</span>
            </h2>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
              <span className="text-[#00ADB5]">Strengthen Your</span> Business with Governance
            </h2>
            <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
              Strengthen your business with governance. Contact us for corporate governance services!
            </p>
            <Link
              href="/contact-us"
              ...
              aria-label="Contact us for governance services"
            >
              Contact Us
