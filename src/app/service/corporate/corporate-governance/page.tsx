...
import { FileText, Users, Shield, X } from 'lucide-react';
import Link from 'next/link';
import { useState, useCallback, useMemo, type JSX } from 'react';

// Define the interface for Corporate Governance service info
interface CorporateGovernanceServiceInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
// Corporate Governance services data
const corporateGovernanceServices = [
  {
    id: 1,
    icon: FileText,
    title: 'Policy Development',
    description: 'We create governance policies tailored to your business.',
    ...
    detailedContent: `• Comprehensive assessment of your governance needs
• Custom policy development for your industry
• Code of conduct and ethics policies
• Whistleblower policy creation
• Board charter development
• Shareholder communication policies
• ESG (Environmental, Social, Governance) framework development`
  },
  {
    id: 2,
    icon: Users,
    title: 'Board Advisory',
    description: 'We provide guidance on board structure and responsibilities.',
    image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=1764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    category: "Advisory",
    detailedContent: `• Board composition and structure guidance
• Director roles and responsibilities definition
• Board committee formation and charters
• Director onboarding and training programs
...
• Conflict of interest management`
  },
  {
    ...
    description: 'We ensure adherence to governance standards and regulations.',
    ...
    category: "Compliance",
    detailedContent: `• Regulatory compliance monitoring
...
const benefits = [
  'Enhance transparency and accountability in your operations',
  'Build investor and stakeholder confidence in your business',
  'Mitigate risks through structured decision-making processes',
];

export default function CorporateGovernancePage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<CorporateGovernanceServiceInfo | null>(null);

  const handleExploreClick = useCallback((info: CorporateGovernanceServiceInfo) => {
...
const Popup = ({ selectedInfo, onClose }: { selectedInfo: CorporateGovernanceServiceInfo; onClose: () => void }) => {
  return (
    <motion.div
  ...
  return (
    <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=1764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      ...
      >
        ...
        <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
          Ensure Transparency with Robust Corporate Governance
        </p>
      </motion.div>
    </section>
  );
              ...
              <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                    Strong corporate governance is essential for transparency, accountability, and long-term success. At Leonard Corporate Solutions, we help you implement robust governance frameworks to protect your business and build trust with stakeholders.
                  </p>
                  <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                    Our comprehensive approach includes policy development, board advisory services, and compliance monitoring to ensure your business operates with integrity and meets all regulatory requirements.
                  </p>
                  <p className="text-base md:text-lg font-medium text-[#393E46]">
                    📩 For expert corporate governance:{" "}
            ...
            <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
              <div className="absolute inset-0">
                <img 
                  ...
                  alt="Corporate Governance visual" 
...
const ServiceCard = ({ service, index, onClick }: { 
  service: CorporateGovernanceServiceInfo; 
  index: number; 
  onClick: (info: CorporateGovernanceServiceInfo) => void; 
}) => {
  return (
    <motion.div
    ...
    >
      <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
        <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
          At Leonard Corporate Solutions, our corporate governance services ensure your business operates with integrity, transparency, and compliance, building trust with stakeholders and creating a foundation for sustainable growth.
        </p>
        <Link
          href="/contact"
