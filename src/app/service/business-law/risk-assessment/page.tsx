      ...
      <motion.section className="relative min-h-[50vh] sm:min-h-[60vh] md:min-h-[80vh] flex items-center justify-center">
        ...
        <motion.div className="max-w-7xl mx-auto text-center px-4">
          ...
          <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Protect Your Business with Risk Assessment & Mitigation
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          <div className="space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#00ADB5]">Our Risk</span>{' '}
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              ...
              <span className="text-[#222831]">Risk Mitigation</span>
            </h2>
            <div className="text-sm sm:text-base text-[#393E46] leading-relaxed">
              {riskBenefits.map((benefit, index) => (
                <span key={index} className="inline-block align-top pl-8 sm:pl-10" style={{ textIndent: '-1.5rem' }}>
                  <span className="text-[#00ADB5] text-base sm:text-lg pr-2">✦</span>
                  {benefit}
                  {index < riskBenefits.length - 1 && <span className="mx-2">•</span>}
                </span>
              ))}
            </div>
          </motion.div>
          ...
          >
            <div className="relative py-8 sm:py-12">
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-[#00ADB5]" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-[#00ADB5]" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Mitigate Risks with Expert Strategies</h2>
              <p className="text-[#393E46] text-sm sm:text-lg leading-relaxed mb-6">
                Minimize risks and secure your operations. Contact us for risk assessment services!
              </p>
              <Link
                href="/contact-us"
