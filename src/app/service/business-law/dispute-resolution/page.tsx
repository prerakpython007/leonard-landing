  ...
  const features = [
    {
      icon: HandshakeIcon,
      title: "Mediation",
      description: "Expert mediation services for business disputes."
    },
    {
      icon: Scale,
      title: "Arbitration",
      description: "Professional arbitration proceedings."
    },
    {
      icon: Gavel,
      title: "Litigation Support",
      description: "Comprehensive litigation assistance."
    },
    {
      icon: MessageCircle,
      title: "Negotiation",
      description: "Strategic dispute negotiation services."
    },
    {
      icon: Shield,
      title: "Rights Protection",
      description: "Safeguarding business interests."
    },
    {
      icon: FileText,
      title: "Documentation",
      description: "Complete dispute documentation support."
    }
  ];
      ...
      <motion.section className="relative h-[80vh] flex items-center justify-center px-4 md:px-16 lg:px-24">
        ...
        <motion.div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-8 text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Expert Business Dispute Resolution Services
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto space-y-32">
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            ...
            <div className="text-[#393E46] space-y-6">
              <p className="text-lg leading-relaxed">
                Our dispute resolution services provide comprehensive support for resolving business conflicts efficiently. We offer multiple resolution pathways including mediation, arbitration, and litigation support.
              </p>
              <ul className="space-y-4 list-none pl-5">
                {resolutionPoints.map((item, index) => (
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            <div className="text-[#393E46] space-y-6">
              ...
              <p className="text-lg leading-relaxed">
                Contact us to learn how our dispute resolution services can help resolve your business conflicts effectively and efficiently.
              </p>
            </div>
          </motion.div>
        </div>
