  ...
  const features = [
    {
      ...
      description: "Development of comprehensive corporate policies."
    },
    {
      icon: Shield,
      title: "Risk Management",
      description: "Policy-based risk mitigation strategies."
    },
    {
      icon: Settings,
      title: "Process Integration",
      description: "Seamless policy implementation procedures."
    },
    {
      icon: CheckSquare,
    ...
    },
    {
      ...
      description: "Inclusive policy development approach."
    },
    {
      icon: Briefcase,
      title: "Policy Management",
      description: "Ongoing policy review and updates."
    }
  ];
      ...
      <motion.section className="relative h-[80vh] flex items-center justify-center px-4 md:px-16 lg:px-24">
        ...
        <motion.div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-8 text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Strategic Corporate Policy Development Services
          </p>
        </motion.div>
      </motion.section>
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            ...
            <div className="text-[#393E46] space-y-6">
              <p className="text-lg leading-relaxed">
                Our policy development services help organizations create and implement effective corporate policies. We ensure your policies align with regulatory requirements while supporting operational efficiency.
              </p>
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            <div className="text-[#393E46] space-y-6">
              <h2 className="text-3xl font-bold text-center mb-8">
                ...
                <span className="text-[#222831]">Policy Services</span>
              </h2>
              <p className="text-lg leading-relaxed">
                Contact us to learn how our policy development services can help establish effective governance frameworks for your organization.
              </p>
            </div>
          </motion.div>
        </div>
