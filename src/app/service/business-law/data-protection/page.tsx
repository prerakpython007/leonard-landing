...
export default function DataProtectionPage() {
  const features = [
    ...
    },
    {
      ...
      description: "GDPR and DPDP compliance solutions."
    },
    {
      icon: Search,
      title: "Data Audit",
      description: "Thorough data processing assessment."
    },
    {
      icon: FileText,
      title: "Documentation",
    ...
    },
    {
      ...
      description: "Privacy framework implementation."
    },
    {
      icon: AlertTriangle,
      title: "Breach Management",
      description: "Data breach response protocols."
    }
  ];
      ...
      <motion.section className="relative h-[80vh] flex items-center justify-center px-4 md:px-16 lg:px-24">
        ...
        <motion.div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-8 text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Comprehensive Data Protection & Privacy Compliance
          </p>
        </motion.div>
      </motion.section>
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            ...
            <div className="text-[#393E46] space-y-6">
              <p className="text-lg leading-relaxed">
                Our data protection services ensure your organization's compliance with privacy regulations including GDPR and DPDP. We provide comprehensive support for data security, privacy frameworks, and breach management.
              </p>
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            <div className="text-[#393E46] space-y-6">
              <h2 className="text-3xl font-bold text-center mb-8">
                ...
                <span className="text-[#222831]">Privacy Solutions</span>
              </h2>
              <p className="text-lg leading-relaxed">
                Contact us to learn how our data protection services can help ensure your organization's compliance with privacy regulations.
              </p>
            </div>
          </motion.div>
        </div>
