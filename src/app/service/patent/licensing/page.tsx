...
const patentLicensingInfo: PatentLicensingInfo[] = [
  {
    ...
    description: 'Granting permission to use your invention under specific terms.',
    ...
    detailedContent: `
      • Permitting third parties to use, manufacture, or sell your patented invention.
      • Involving a legal agreement outlining terms of use and compensation.
      • Retaining patent ownership while generating revenue.
      • Tailoring to specific markets, regions, or applications.
      • Including royalties or lump-sum payments.
      • Requiring careful drafting to protect patent rights.
    `,
  },
  {
    id: 2,
    title: 'Benefits of Licensing',
    description: 'Generates revenue and expands market reach without losing ownership.',
    category: 'Advantages',
    image: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?auto=format&fit=crop&q=80&w=1200",
    detailedContent: `
      • Providing a steady income stream through royalties or fees.
      • Expanding market presence without direct investment.
      • Enabling partnerships with industry leaders for innovation.
      • Reducing risk by leveraging licensees' resources.
      • Maintaining control over the patent while monetizing it.
      • Enhancing brand visibility through licensed products.
    `,
  },
  {
    id: 3,
    title: 'Types of Licenses',
    description: 'Exclusive, non-exclusive, or sole licenses tailored to your strategy.',
    category: 'License Types',
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=1200",
    detailedContent: `
      • Exclusive License: Granting rights to one licensee, excluding others.
      • Non-Exclusive License: Allowing multiple licensees to use the patent.
      • Sole License: Granting rights to one licensee but allowing owner use.
      • Including geographic or field-of-use restrictions.
      • Tailoring to align with business and market goals.
      • Requiring clear terms to avoid conflicts.
    `,
  },
  {
    id: 4,
    title: 'Licensing Process',
    description: 'Identify licensees, negotiate terms, and draft agreements.',
    category: 'Procedure',
    image: "https://blog.ipleaders.in/wp-content/uploads/2021/07/shutterstock_481442011-800x445-1.jpg",
    detailedContent: `
      • Identifying companies or partners interested in your technology.
      • Evaluating licensee suitability based on market and capabilities.
      • Negotiating terms like royalties, exclusivity, and duration.
      • Drafting a detailed licensing agreement with legal support.
      • Executing the agreement and monitoring compliance.
      • Addressing breaches or disputes through enforcement mechanisms.
    `,
  },
  {
    id: 5,
    title: 'Legal Agreements',
    description: 'Robust agreements ensure compliance and fair compensation.',
    category: 'Protection',
    ...
    detailedContent: `
      • Defining rights, obligations, and restrictions for all parties.
      • Including clauses for royalties, termination, and dispute resolution.
      • Ensuring compliance with patent laws and regulations.
      • Protecting against unauthorized use or infringement.
      • Specifying monitoring and auditing mechanisms.
      • Safeguarding your intellectual property during licensing.
    `,
  },
];
...
const licensingServices = [
  {
    ...
    description: 'We find suitable partners for your patented technology.',
  ...
  },
  {
    ...
    description: 'We create robust licensing contracts to protect your rights.',
  ...
  },
  {
    ...
    description: 'We ensure licensees adhere to agreement terms.',
    image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&q=80&w=1200",
    category: "Monitoring",
  },
];
...
const benefits = [
  'Generate revenue through royalties or licensing fees',
  'Expand market reach without direct investment',
  'Foster strategic partnerships for growth and innovation',
];
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert patent licensing services to monetize your inventions through strategic partnerships and robust legal agreements.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in patent licensing to help you monetize your inventions while retaining ownership. Our skilled team identifies suitable licensees, negotiates favorable terms, and drafts robust agreements to maximize your revenue potential.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our patent licensing services include licensee identification, agreement drafting, compliance monitoring, and strategic planning to ensure your intellectual property generates maximum value.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpNIFrLiVpXCFWJic-xi3pn8EWvIWjjb2drlEsizk-9opNzhgoyME6IFiM1DoEchwgVBQ&usqp=CAU" alt="Patent Licensing visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="relative px-4 bg-[#000000] py-12 md:py-16 lg:py-24 md:px-16 lg:px-24">
        <div className="relative mx-auto max-w-7xl">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {patentLicensingInfo.map((info, index) => (
              <motion.div
                key={info.id}
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our patent licensing services help you maximize the value of your inventions through strategic partnerships and comprehensive legal agreements.
              </p>
              <Link
                href="/contact"
