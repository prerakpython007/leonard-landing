...
const patentConsultationInfo: PatentConsultationInfo[] = [
  {
    ...
    description: 'Expert guidance on patent strategy, filing, and portfolio management.',
  ...
  },
  {
    ...
    description: 'Informed decisions and optimized patent strategies for your inventions.',
    category: 'Advantages',
  ...
  },
  {
    ...
    description: 'Covers patentability, filing strategies, infringement risks, and portfolio management.',
    category: 'Scope',
  ...
  },
  {
    ...
    description: 'Tailored strategies and ongoing support for patent success.',
    category: 'Procedure',
  ...
  },
  {
    ...
    description: 'Customized advice aligned with your business goals and budget.',
    category: 'Support',
...
const consultationServices = [
  {
    ...
    description: 'We assess the novelty and inventiveness of your invention.',
  ...
  },
  {
    ...
    description: 'We develop tailored plans for national and international filings.',
  ...
  },
  {
    ...
    description: 'We optimize your patent portfolio for maximum protection.',
    image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&q=80&w=1200",
    category: "Management",
  },
];
...
const benefits = [
  'Make informed decisions with expert patent guidance',
  'Optimize protection with tailored filing strategies',
  'Maximize value through strategic portfolio management',
];
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert patent consultation services to guide your patent strategy, filing, and portfolio management with expert insights.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              >
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      Patent Consultation Overview
                    </motion.h1>

                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in patent consultation to guide your business through the complex patent landscape. Our skilled team provides expert advice on patent strategy, filing, and portfolio management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our patent consultation services include patentability analysis, filing strategy development, portfolio management, and strategic planning to ensure your intellectual property is protected effectively.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpNIFrLiVpXCFWJic-xi3pn8EWvIWjjb2drlEsizk-9opNzhgoyME6IFiM1DoEchwgVBQ&usqp=CAU" alt="Patent Consultation visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-8 md:mb-12 lg:mb-16 text-center">
            <motion.h1
              ...
              viewport={{ once: true, margin: "0px 0px -100px 0px" }}
            >
              Patent Consultation Information
            </motion.h1>
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {patentConsultationInfo.map((info, index) => (
              <motion.div
                key={info.id}
          ...
          <div className="mt-16 md:mt-24 lg:mt-32">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Our Patent Consultation Services
            </motion.h2>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our patent consultation services ensure your innovations are protected with strategic guidance and comprehensive patent expertise.
              </p>
              <Link
                href="/contact"
              ...
              >
                Start Your Patent Consultation
