      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert patent opposition services to challenge invalid patents and protect your market interests with strategic legal arguments and evidence.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              >
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      Patent Opposition Overview
                    </motion.h1>

                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in patent opposition to protect your business from invalid or overly broad patents. Our skilled team challenges patent applications and granted patents through strategic legal arguments and evidence compilation.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our patent opposition services include evidence gathering, prior art analysis, hearing representation, and strategic planning to ensure your interests are protected in patent office proceedings.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpNIFrLiVpXCFWJic-xi3pn8EWvIWjjb2drlEsizk-9opNzhgoyME6IFiM1DoEchwgVBQ&usqp=CAU" alt="Patent Opposition visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-16 md:mt-24 lg:mt-32">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Our Patent Opposition Services
            </motion.h2>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our patent opposition services ensure your business is protected from invalid patents with strategic legal arguments and comprehensive evidence compilation.
              </p>
              <Link
                href="/contact"
