...
const patentDraftingInfo: PatentDraftingInfo[] = [
  ...
  },
  {
    ...
    description: "Includes a detailed description, claims defining the invention’s scope, abstract, and technical drawings.",
    ...
    <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[5%] font-montserrat">
      ...
      >
        ...
        >
          ...
          <p className="mt-8 text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Craft Robust Patents with Expert Drafting Services
          </p>
        </motion.div>
      </motion.section>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-[#222831] mb-4">Strengthen Your Patent with Expert Drafting</h2>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">Patent Drafting Essentials</h2>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24 bg-[#F7F7F7]">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">Patent Drafting Process</h2>
            <div className="w-24 h-1 bg-[#00ADB5] mx-auto rounded-full"></div>
          </motion.div>
          <div className="space-y-6">
            ...
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">1. Invention Analysis</h3>
              <p className="text-[#393E46]/80">Understand the invention’s technical details, novelty, and commercial potential through detailed discussions.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">2. Claim Drafting</h3>
              <p className="text-[#393E46]/80">Craft precise claims that define the scope of protection, balancing breadth and specificity.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">3. Technical Documentation</h3>
              <p className="text-[#393E46]/80">Prepare detailed descriptions and drawings to clearly illustrate the invention’s functionality and novelty.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">4. Review and Compliance</h3>
              <p className="text-[#393E46]/80">Review the draft for legal and technical accuracy, ensuring compliance with patent office requirements.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">Why Choose Expert Patent Drafting?</h2>
            <div className="w-24 h-1 bg-[#00ADB5] mx-auto rounded-full"></div>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">Higher Approval Rates</h3>
              <p className="text-[#393E46]/80">Meticulous drafting reduces objections and increases the likelihood of patent grant.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 rounded-xl shadow-lg"
            >
              <h3 className="text-xl font-bold text-[#222831] mb-3">Stronger Protection</h3>
              <p className="text-[#393E46]/80">Clear and precise claims ensure robust legal protection against infringement.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-[#393E46]/80">Well-drafted patents minimize costly revisions and legal disputes in the future.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-[#222831] mb-4">Ready to Draft Your Patent?</h2>
            <p className="text-[#393E46]/80 mb-6 max-w-2xl mx-auto">
              Secure your invention with BrandSecure’s expert patent drafting services. Contact us today to create a robust patent application that protects your innovation effectively.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center px-6 py-3 bg-[#00ADB5] text-white font-medium rounded-full hover:bg-[#222831] transition-colors duration-300"
