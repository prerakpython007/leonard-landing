...
const patentDraftingInfo: PatentDraftingInfo[] = [
  {
    ...
    detailedContent: `
      • Involves crafting detailed patent applications to protect inventions.
      • Includes technical descriptions, claims, and supporting drawings.
      • Requires compliance with patent office standards and regulations.
      • Ensures clarity to prevent ambiguities in legal protection.
      • Involves collaboration with inventors to capture technical details.
      • Aims to maximize the scope of protection for the invention.
    `,
  },
  {
    id: 2,
    ...
    category: "Advantages",
    detailedContent: `
      • Increases likelihood of patent approval by patent offices.
      • Strengthens enforceability against potential infringements.
      • Reduces risks of objections or rejections during examination.
      • Enhances the commercial value of the patent.
      • Provides clear boundaries for the invention’s protection.
      • Saves time and costs by minimizing revisions.
    `,
  },
  {
    id: 3,
    ...
    detailedContent: `
      • Detailed description explains the invention’s functionality.
      • Claims define the legal scope of patent protection.
      • Abstract summarizes the invention for quick reference.
      • Technical drawings illustrate the invention’s structure.
      • Background section provides context and prior art.
      • Must comply with patent office formatting rules.
    `,
  },
  {
    id: 4,
    ...
    category: "Procedure",
    detailedContent: `
      • Analyze the invention’s novelty and technical aspects.
      • Draft precise claims to define protection boundaries.
      • Prepare comprehensive technical descriptions and drawings.
      • Conduct prior art searches to ensure originality.
      • Review draft for compliance with legal and technical standards.
      • Finalize application for submission to patent offices.
    `,
  },
  {
    id: 5,
    ...
    category: "Protection",
    detailedContent: `
      • Ensures claims are clear and legally enforceable.
      • Minimizes ambiguities that could lead to disputes.
      • Aligns drafting with international patent standards.
      • Protects against challenges during litigation.
      • Supports licensing and commercialization efforts.
      • Enhances patent strength through precise language.
    `,
  },
];
            ...
            {[
              {
                ...
                description: 'Understand the invention’s technical details, novelty, and commercial potential through detailed discussions.',
              },
              {
              ...
              },
              {
                ...
                description: 'Prepare detailed descriptions and drawings to clearly illustrate the invention’s functionality and novelty.',
              },
              {
