...
const patentRegistrationInfo: PatentRegistrationInfo[] = [
  {
    ...
    description: 'Grants exclusive rights to your invention for up to 20 years.',
    category: 'Patent Basics',
    detailedContent: `
      • Granting exclusive rights to the inventor for up to 20 years.
      • Preventing unauthorized use, manufacture, or sale of the invention.
      • Applying to novel products, processes, or significant improvements.
      • Administered by national or regional patent offices.
      • Requiring a formal application with detailed documentation.
      • Enhancing the inventor’s ability to commercialize the invention.
    `,
  },
  {
    id: 2,
    title: 'Benefits of Registration',
    description: 'Protects your invention and enables licensing or sale.',
    category: 'Advantages',
    detailedContent: `
      • Securing exclusive rights to prevent imitation by competitors.
      • Strengthening market position by establishing ownership.
      • Facilitating licensing agreements for additional revenue.
      • Enabling sale or transfer of the patent for financial gain.
      • Attracting investors by showcasing protected intellectual property.
      • Providing legal recourse against infringement.
    `,
  },
  {
    id: 3,
    title: 'Eligibility Criteria',
    description: 'Inventions must be novel, non-obvious, and industrially applicable.',
    ...
    detailedContent: `
      ...
      • Patentable Subject Matter: Excluding abstract ideas or natural phenomena.
      • Covering products, processes, or significant improvements.
      • Meeting patent office’s specific legal requirements.
    `,
  },
  {
    id: 4,
    title: 'Application Process',
    description: 'File an application, undergo examination, and receive a grant.',
    category: 'Procedure',
    detailedContent: `
      • Preparing a detailed invention disclosure with claims and drawings.
      • Filing a provisional or complete application with the patent office.
      • Paying required fees and submitting necessary forms.
      • Undergoing examination by the patent office for compliance.
      • Responding to office actions or objections, if any.
      • Receiving patent grant and certificate upon approval.
    `,
  },
  {
    id: 5,
    title: 'Legal Protection',
    description: 'Enforce your patent rights against infringers legally.',
    category: 'Protection',
    detailedContent: `
      • Providing legal authority to sue for patent infringement.
      • Enabling injunctions to stop unauthorized use of the invention.
      • Allowing claims for damages or royalties from infringers.
      • Strengthening position in licensing or partnership negotiations.
      • Protecting intellectual property rights in relevant jurisdictions.
      • Requiring monitoring to detect and address violations.
    `,
  },
];
...
const registrationServices = [
  {
    ...
    description: 'We prepare detailed patent applications to meet legal standards.',
  },
  {
    icon: Gavel,
    title: 'Examination Support',
    description: 'We respond to patent office actions to secure approval.',
  },
  {
    icon: Shield,
    title: 'Infringement Protection',
    description: 'We enforce your patent rights against unauthorized use.',
  },
];

const benefits = [
  'Secure exclusive rights to your invention',
  'Generate revenue through licensing or sale',
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6">
              <p className="text-base sm:text-lg leading-relaxed">
                Patent registration grants you exclusive rights to your invention, protecting it from unauthorized use for up to 20 years. At BrandSecure, we streamline the patent filing process, guiding you from application to grant to ensure your intellectual property is secure in India and globally.
              </p>
            </div>
          </motion.div>
          ...
          <div className="space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              ...
              <span className="text-black">Patent Registration</span>
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
              {patentRegistrationInfo.map((info, index) => (
                <motion.div
                  key={info.id}
          ...
          <div className="space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              ...
              <span className="text-black">Register Patents</span>
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          ...
          >
            <div className="relative py-8 sm:py-12">
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-black" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-black" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Protect Your Invention</h2>
              <p className="text-[#393E46] text-sm sm:text-lg leading-relaxed mb-6">
                Safeguard your innovation with expert patent registration. Contact us today!
              </p>
              <Link
                href="/contact-us"
