    ...
    <div className="min-h-screen bg-gradient-to-b from-[#EEEEEE] via-white to-[#EEEEEE]">
      ...
      >
        ...
        <div className="relative text-center mb-12 w-full">
          ...
          >
            Resolving Domain Name Disputes Swiftly and Efficiently
          </motion.p>
        </div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-[#222831] mb-6 relative">
              <span className="relative z-10">Domain Name Law Overview</span>
              <span className="absolute bottom-0 left-0 h-3 w-20 bg-[#00ADB5]/20 -z-10"></span>
            </h2>
            <p className="text-[#393E46] text-lg leading-relaxed">
              Domain name disputes require swift and efficient resolution, as domain names are a critical component of a
              company’s intellectual property portfolio. In the early days of the internet, court proceedings were the only
              recourse for addressing improper domain name use. Today, streamlined procedures introduced since the late
              1990s offer quick, cost-effective, and self-enforcing solutions to tackle domain name infringements, regardless
              of the infringer’s location.
            </p>
            <p className="text-[#393E46] text-lg leading-relaxed mt-4">
              Our experienced team has a unique advantage, having successfully represented both claimants and defendants in
              domain name proceedings. This dual perspective allows us to provide strategic and balanced advice to protect
              your brand and resolve disputes effectively.
            </p>
            <p className="text-[#393E46] text-lg leading-relaxed mt-4">
              Contact us at{" "}
              ...
              for expert assistance with your domain name disputes or portfolio management.
            </p>
          </motion.div>
...
const serviceCards = [
  ...
  },
  {
    ...
    description: "Provide expert representation in court for complex domain name disputes."
  },
  {
    icon: Briefcase,
  ...
  },
  {
    ...
    description: "Represent both claimants and defendants in domain name proceedings with balanced expertise."
  },
  {
    icon: Globe,
