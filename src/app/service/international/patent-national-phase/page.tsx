          ...
          >
            ...
            <div className="text-center space-y-6">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                <span className="text-black">Transition to</span>{' '}
            ...
            {nationalPhaseInfo.map((info: NationalPhaseInfo, index: number) => (
              ...
              >
                ...
                <div className="flex flex-col gap-5 relative z-10">
                  ...
                  <p className="text-sm sm:text-base text-[#393E46]/80 leading-relaxed line-clamp-3">{info.description}</p>
                  <button
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              ...
              <span className="text-black">National Phase Considerations</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-4 md:px-16">
            {[
              ...
              >
                ...
                <p className="text-sm sm:text-base text-[#393E46]/80 leading-relaxed">{country.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              ...
              <span className="text-black">the National Phase</span>
            </h2>
          </div>
