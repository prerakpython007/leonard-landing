          ...
          >
            ...
            <div className="text-center space-y-6">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                <span className="text-black">Protect Your</span>{' '}
              ...
              >
                ...
                <div className="flex flex-col gap-5 relative z-10">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-black text-white font-medium rounded-full hover:bg-[#222831] transition-colors duration-300 mt-4 cursor-pointer"
                  >
                    Explore
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              ...
              <span className="text-black">a PCT Application</span>
            </h2>
          </div>
