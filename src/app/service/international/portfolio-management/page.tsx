...
const portfolioManagementInfo: PortfolioManagementInfo[] = [
  {
    ...
    description:
      "Trademark and patent portfolio management involves strategically overseeing IP assets across jurisdictions to maximize value and ensure compliance.",
  ...
  },
  {
    ...
    description:
      "Effective portfolio management enhances IP value, reduces costs, and strengthens brand protection for multinationals in global markets.",
    category: "Advantages",
    detailedContent: `
  ...
  },
  {
    ...
    description:
      "The process involves auditing, strategizing, implementing, and monitoring trademark and patent portfolios for optimal performance.",
  ...
  },
  {
    ...
    description:
      "Advanced tools and platforms streamline IP tracking, analytics, and compliance for multinational portfolios.",
  ...
  },
  {
    ...
    description:
      "Managing multinational IP portfolios involves navigating complex legal systems, high costs, and coordination across jurisdictions.",
    ...
    <div className="min-h-screen bg-[#EEEEEE] relative font-sans overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="mt-8 text-xl text-white/90 max-w-2xl mx-auto font-light">Optimize Your Global IP Assets</p>
        </motion.div>
      </motion.section>
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-base sm:text-lg text-[#393E46] leading-relaxed">
                      Trademark and patent portfolio management for multinationals involves strategically overseeing IP
                      assets to ensure protection, compliance, and alignment with global business objectives. At
                      BrandSecure, we provide tailored solutions to streamline IP management, reduce risks, and enhance
                      value for multinational corporations operating across jurisdictions.
                    </p>
                  </div>
              ...
              <div className="relative z-10 h-[420px] w-full lg:w-2/5">
                <div className="absolute inset-0 overflow-hidden">
                  <img
                    ...
                    alt="IP portfolio management visual"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#eeeeee]">Portfolio Management</span>{" "}
      ...
      <section className="py-32 px-4 md:px-16 lg:px-24 bg-[#000000]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#eeeeee]">Key Management</span> <span className="text-[#00ADB5]">Services</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 md:gap-12 px-2 sm:px-4 md:px-16">
            {[
      ...
      <section className="py-32 px-4 md:px-16 lg:px-24 bg-black">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#eeeeee]">How We Manage</span>{" "}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white">
              ...
              <span className="text-[#00ADB5]">Your IP Portfolio?</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-[#e0e0e0] leading-relaxed mb-8">
              Partner with BrandSecure to streamline your trademark and patent portfolio management, ensuring global
              protection and value for your multinational operations. Start today with our expert guidance.
            </p>
            <Link
              href="/contact-us"
