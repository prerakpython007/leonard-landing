...
const legalSupportInfo: LegalSupportInfo[] = [
  {
    ...
    description:
      "Legal support for Indian startups going global involves tailored solutions to navigate international IP laws, compliance, and business regulations.",
  ...
  },
  {
    ...
    description:
      "Legal support enables Indian startups to protect their brand, comply with global laws, and compete effectively in international markets.",
    category: "Advantages",
    detailedContent: `
  ...
  },
  {
    ...
    description:
      "The process includes assessing legal needs, securing IP, setting up operations, and ensuring compliance in target markets.",
  ...
  },
  {
    ...
    description:
      "Protecting IP internationally involves leveraging treaties like Madrid, PCT, and Hague to secure startup assets in key markets.",
  ...
  },
  {
    ...
    description:
      "Indian startups face challenges like complex foreign regulations, high IP costs, and cultural barriers when expanding globally.",
    ...
    <div className="min-h-screen bg-black relative font-sans overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="mt-8 text-xl text-white/90 max-w-2xl mx-auto font-light">Expand Globally with Confidence</p>
        </motion.div>
      </motion.section>
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-base sm:text-lg text-[#393E46] leading-relaxed">
                      Indian startups aiming for global markets face complex legal and IP challenges. At BrandSecure, we
                      provide expert legal support to help startups protect their intellectual property, comply with
                      international regulations, and establish a strong presence abroad. Our tailored solutions empower
                      Indian startups to scale confidently and succeed globally.
                    </p>
                  </div>
              ...
              <div className="relative z-10 h-[420px] w-full lg:w-2/5">
                <div className="absolute inset-0 overflow-hidden">
                  <img
                    ...
                    alt="Global legal support visual"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#eeeeee]">Legal Support</span> <span className="text-[#00ADB5]">Essentials</span>
            </h2>
          </div>
      ...
      <section className="py-32 px-4 md:px-16 lg:px-24 bg-black">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#eeeeee]">How to Expand</span> <span className="text-[#00ADB5]">Globally</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 px-2 sm:px-4 md:px-16">
            ...
            >
              <div className="flex flex-col gap-5 relative z-10">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Eligible Startups</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white">
              Ready to Go <br />
              <span className="text-[#00ADB5]">Global?</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-[#e0e0e0] leading-relaxed mb-8">
              Partner with BrandSecure for expert legal support to protect your IP and navigate global markets,
              empowering your Indian startup to succeed internationally with confidence.
            </p>
            <Link
              href="/contact-us"
