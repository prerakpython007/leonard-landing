      ...
      >
        ...
        >
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-extrabold text-[#222831] relative inline-block tracking-tight">
            Trademark Filing
            <span className="absolute top-1/2 -left-8 sm:-left-16 -translate-y-1/2 text-black text-3xl sm:text-5xl animate-pulse opacity-50">✦</span>
            <span className="absolute top-1/2 -right-8 sm:-right-16 -translate-y-1/2 text-black text-3xl sm:text-5xl animate-pulse opacity-50">✦</span>
          </h1>
          ...
          >
            ...
            <div className="text-center space-y-6">
              <h2 className="text-4xl font-bold mb-4">
                <span className="text-black">Globalize</span>{' '}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              ...
              <span className="text-black">the Madrid Protocol</span>
            </h2>
          </div>
