      ...
      >
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Ensure Your Design’s Uniqueness
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831]">
                <span className="text-[#00ADB5]">Verify</span> Design Originality
              </h2>
              <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                Conduct thorough searches to ensure your design is unique and avoid conflicts. At Leonard Corporate Solutions, we perform comprehensive design searches to verify originality, helping you secure your designs with confidence in India and globally.
              </p>
            </div>
          </motion.div>
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Our Design Search</span> <span className="text-[#00ADB5]">Services</span>
            </h2>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
              <span className="text-[#00ADB5]">Ensure</span> Design Uniqueness
            </h2>
            <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
              Ensure your design is unique. Contact us for design search services today!
            </p>
            <Link
              href="/contact-us"
              ...
              aria-label="Contact us for design search services"
            >
              Contact Us
