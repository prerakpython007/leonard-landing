...
import { Search, ShieldCheck, FileSearch, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for design search info
interface DesignSearchInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const designSearchServices = [
  {
    icon: Search,
    title: 'Prior Art Search',
    description: 'Conduct thorough searches to identify existing designs and avoid conflicts.',
  ...
  },
  {
    ...
    description: 'Analyze search results to ensure your design is unique and registrable.',
  ...
  },
  {
    ...
    description: 'Receive detailed reports to guide your design registration strategy.',
...
const benefits = [
  'Identify potential conflicts before filing design applications',
  'Save time and resources with comprehensive search services',
  'Make informed decisions with expert analysis of search results',
];

export default function DesignSearchPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<DesignSearchInfo | null>(null);

  const handleExploreClick = (info: DesignSearchInfo) => {
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1594909122845-11baa439b7bf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
            alt="Design Search hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert design search services to verify the uniqueness of your creations and avoid potential conflicts.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              >
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      Design Search Overview
                    </motion.h1>

                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in design search services to verify the uniqueness of your creations. Our skilled team provides expert analysis to identify potential conflicts and ensure your designs are registrable.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our design search services include prior art searches, clearance analysis, and comprehensive reporting to guide your design registration strategy.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1434626881859-194d67b2b86f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1174&q=80" alt="Design Search visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mt-16 md:mt-24 lg:mt-32">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              {designSearchServices.map((service, index) => (
                <motion.div
                  key={service.title}
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our design search services ensure your creations are unique and registrable with strategic guidance and comprehensive expertise.
              </p>
              <Link
                href="/contact"
