...
import { Brush, ShieldCheck, FilePenLine } from 'lucide-react';
...
export default function SurfaceDesignsPage() {
  const features = [
    {
      icon: Brush,
      title: 'Surface Design Registration',
      description: 'Register ornamental surface designs to protect their unique visual appeal.',
    },
    {
      icon: ShieldCheck,
      title: 'Infringement Monitoring',
      description: 'Track and protect your surface designs from unauthorized replication.',
    },
    {
      icon: FilePenLine,
      title: 'Design Renewal Support',
      description: 'Ensure continuous protection with timely renewals and updates.',
    },
  ];
      ...
      >
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Enhance and Protect Your Product Surfaces
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831]">
                <span className="text-[#00ADB5]">Protect</span> Your Surface Designs
              </h2>
              <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                Protect ornamental designs applied to product surfaces, enhancing their visual appeal. At Leonard Corporate Solutions, we secure your surface designs, ensuring their distinctive aesthetics are legally protected in India and worldwide.
              </p>
            </div>
          </motion.div>
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Our Surface Design</span> <span className="text-[#00ADB5]">Services</span>
            </h2>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
              <span className="text-[#00ADB5]">Secure</span> Your Surface Designs
            </h2>
            <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
              Protect your ornamental surface designs. Contact us for surface design protection services today!
            </p>
            <Link
              href="/contact-us"
              ...
              aria-label="Contact us for surface design protection"
            >
              Contact Us
