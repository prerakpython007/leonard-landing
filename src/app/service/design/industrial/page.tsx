...
import { Factory, ShieldCheck, FilePenLine } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Register your industrial designs to secure exclusive rights and legal protection.',
    },
    {
      icon: ShieldCheck,
      title: 'Infringement Protection',
      description: 'Monitor and enforce your design rights against unauthorized use or copying.',
    },
    {
      icon: FilePenLine,
      title: 'Portfolio Management',
      description: 'Manage your design portfolio with strategic renewals and documentation.',
    },
  ];
      ...
      >
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Protect the Unique Aesthetics of Your Products
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="text-[#393E46] space-y-4 sm:space-y-6 text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831]">
                <span className="text-[#00ADB5]">Safeguard</span> Your Industrial Designs
              </h2>
              <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                Protect the aesthetic and functional aspects of industrial products through design registration. At Leonard Corporate Solutions, we safeguard your innovative designs, ensuring their unique visual and practical elements are legally protected in India and beyond.
              </p>
            </div>
          </motion.div>
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
              <span className="text-[#222831]">Our Industrial Design</span> <span className="text-[#00ADB5]">Services</span>
            </h2>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
              <span className="text-[#00ADB5]">Protect</span> Your Industrial Designs
            </h2>
            <p className="text-[#393E46] text-sm sm:text-base md:text-lg leading-relaxed mb-6">
              Protect your product’s aesthetic and functional designs. Contact us for industrial design services today!
            </p>
            <Link
              href="/contact-us"
              ...
              aria-label="Contact us for industrial design services"
            >
              Contact Us
