...
import { Factory, ShieldCheck, FilePenLine, Search, FileText, Shield, X } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Define the interface for industrial design info
interface IndustrialDesignInfo {
  id: number;
  title: string;
  description: string;
  category: string;
...
const industrialDesignInfo: IndustrialDesignInfo[] = [
  {
    id: 1,
    title: 'What is Industrial Design Protection?',
    description: 'Industrial design protection safeguards the visual appearance of products, including shape, configuration, pattern, or ornamentation.',
    category: 'Design Basics',
    image: "https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?auto=format&fit=crop&q=80&w=1200",
    detailedContent: `
      • Governed by the Designs Act, 2000 in India.
      • Protects the visual appearance, not functional aspects.
      • Covers shape, configuration, pattern, or ornamentation.
      • Must be new, original, and not disclosed previously.
      • Registration provides exclusive rights for 10 years, renewable for 5 more.
      • Essential for consumer products, appliances, furniture, etc.
    `,
  },
  {
    id: 2,
    title: 'Benefits of Registration',
    description: 'Design registration prevents unauthorized copying, adds commercial value, and provides legal recourse against infringement.',
    category: 'Advantages',
    image: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&q=80&w=1200",
    detailedContent: `
      • Exclusive right to use the design for 10+5 years.
      • Legal protection against imitation and counterfeiting.
      • Enhances commercial value and marketability of products.
      • Provides basis for legal action against infringers.
      • Can be licensed or assigned for royalty income.
      • Deters competitors from copying your designs.
    `,
  },
  {
    id: 3,
    title: 'Eligible Designs',
    description: 'Industrial designs apply to a wide range of products including packaging, furniture, household products, and electronic devices.',
    ...
    detailedContent: `
      ...
      • Surface patterns and ornamentations.
      • Composition of lines or colors.
      • Applied to 3D or 2D designs.
      • Must have visual appeal and be applied to an article.
  ...
  },
  {
    ...
    description: 'The registration process involves application filing, examination, and certification, typically taking 6-12 months.',
    category: 'Procedure',
    image: "https://images.unsplash.com/photo-1605792657660-596af9009e82?auto=format&fit=crop&q=80&w=1200",
    detailedContent: `
      • Conduct novelty search to ensure design is unique.
      • Prepare representations and drawings of the design.
      • File application with the Design Wing of the Patent Office.
      • Examination for compliance with formal requirements.
      • Response to objections if raised by examiner.
  ...
  },
  {
    ...
    description: 'The Hague System allows for international design registration across multiple countries with a single application.',
    ...
    detailedContent: `
      • Hague Agreement facilitates international registration.
      • Single application can cover up to 92 countries.
      • Simplifies maintenance and renewal processes.
      • Reduces costs compared to individual country filings.
      • Important for businesses with global markets.
      • Strategic consideration for export-oriented companies.
    `,
  },
];
...
const designServices = [
  {
    icon: Search,
    title: 'Design Search & Analysis',
    description: 'We conduct comprehensive searches to ensure your design is novel and registrable.',
    image: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&q=80&w=1200",
    category: "Analysis",
  },
  {
    ...
    description: 'We develop tailored plans for design registration and portfolio management.',
    image: "https://images.unsplash.com/photo-1605792657660-596af9009e82?auto=format&fit=crop&q=80&w=1200",
    category: "Strategy",
  },
  {
    ...
    description: 'We help protect your designs against infringement and unauthorized use.',
    image: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?auto=format&fit=crop&q=80&w=1200",
    category: "Protection",
  },
];
...
const benefits = [
  'Secure exclusive rights to your product designs',
  'Enhance commercial value and market position',
  'Prevent copying and counterfeiting of your products',
];

export default function IndustrialDesignsPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<IndustrialDesignInfo | null>(null);

  const handleExploreClick = (info: IndustrialDesignInfo) => {
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert design registration services to protect the aesthetic appearance of your products, from consumer goods to industrial equipment.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in industrial design registration to protect the aesthetic appearance of your products. Our skilled team provides expert advice on design registration, enforcement, and portfolio management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our design services include novelty searches, registration strategy, enforcement support, and portfolio management to ensure your product designs are protected effectively.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?auto=format&fit=crop&q=80&w=1200" alt="Industrial Design visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="relative px-4 bg-[#000000] py-12 md:py-16 lg:py-24 md:px-16 lg:px-24">
        <div className="relative mx-auto max-w-7xl">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {industrialDesignInfo.map((info, index) => (
              <motion.div
                key={info.id}
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our design registration services ensure your product aesthetics are protected with strategic guidance and comprehensive expertise.
              </p>
              <Link
                href="/contact"
              ...
              >
                Start Your Design Registration
