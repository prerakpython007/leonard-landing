...
import { Briefcase, ShieldCheck, FilePenLine, Search, FileText, Shield, X } from 'lucide-react';
...
const designServices = [
  {
    ...
    detailedContent: `• End-to-end design registration process management
    • Preparation and filing of design applications
    • Liaison with design offices throughout the process
    • Handling formalities and compliance requirements
    • Tracking application status and deadlines
    • Expert guidance on design classification
    • Coordination with international design offices for global protection`
  },
  {
    icon: ShieldCheck,
    ...
    category: "Support",
    detailedContent: `• Response to examination reports and objections
    • Overcoming registration obstacles and refusals
    • Argument drafting for design distinctiveness
    • Hearing representation and advocacy
    • Amendment of applications when required
    • Expert opinion on registrability issues
    • Strategic approaches to overcome rejections`
  },
  {
    icon: FilePenLine,
    ...
    category: "Management",
    detailedContent: `• Strategic portfolio development and optimization
    • Maintenance of design registrations and renewals
    • Portfolio valuation and monetization strategies
    • Design audit and gap analysis services
    • Licensing and assignment support
    • Portfolio consolidation and organization
    • International portfolio coordination
    • Monitoring and enforcement strategy development`
  },
];

const benefits = [
  'Streamline your design protection process with expert guidance',
  'Maximize protection with tailored registration strategies',
  'Enhance portfolio value through strategic management',
];

export default function DesignServicesPage() {
  const [showPopup, setShowPopup] = useState(false);
  const [selectedInfo, setSelectedInfo] = useState<DesignServiceInfo | null>(null);

  const handleExploreClick = (info: DesignServiceInfo) => {
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1605106702730-a6b9d006a86e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Comprehensive design protection and management services to safeguard your creative assets and maximize their value.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we provide comprehensive design services to protect and manage your creative assets. Our expert team offers end-to-end support for design registration, prosecution, and portfolio management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our services include comprehensive registration support, prosecution assistance, and strategic portfolio management to ensure your designs are protected effectively in India and globally.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Design Services visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our design services ensure your creative assets are protected with strategic guidance and comprehensive expertise.
              </p>
              <Link
                href="/contact"
