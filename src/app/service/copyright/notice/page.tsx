...
const copyrightNoticeInfo: CopyrightNoticeInfo[] = [
  ...
  },
  {
    ...
    description: 'A copyright notice deters unauthorized use, informs the public of ownership, and strengthens legal claims in infringement cases, though its not mandatory.',
    category: 'Purpose',
  ...
  },
  {
    ...
    description: 'A typical notice includes the copyright symbol ©, the year of first publication, and the copyright owners name, e.g., © 2023 John Doe.',
    category: 'Structure',
  ...
  },
  {
    id: 5,
    title: 'Legal Effect',
    description: 'While not required under Indian law, a notice reinforces ownership claims and may limit an infringers defense of innocent infringement.',
...
const copyrightServices = [
  {
    ...
    description: 'We assess the proper format and placement of your copyright notice.',
    image: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&q=80&w=1200",
    category: "Analysis",
  },
  {
    icon: FileText,
    title: 'Notice Strategy',
    description: 'We develop tailored plans for copyright notice implementation.',
    image: "https://images.unsplash.com/photo-1542435503-956c469947f6?auto=format&fit=crop&q=80&w=1200",
    category: "Strategy",
  },
  {
...
const benefits = [
  ...
  'Optimize protection with tailored notice strategies',
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert copyright notice consultation services to protect your creative works, from books and music to digital content and software.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in copyright notices to protect your creative works. Our skilled team provides expert advice on notice implementation, enforcement, and management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our copyright services include notice analysis, implementation strategy, enforcement support, and strategic planning to ensure your creative works are protected effectively.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1541961017774-22349e4a1262?auto=format&fit=crop&q=80&w=1200" alt="Copyright Notice visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our copyright services ensure your creative works are protected with strategic guidance and comprehensive copyright expertise.
              </p>
              <Link
                href="/contact"
              ...
              >
                Start Your Copyright Notice Implementation
