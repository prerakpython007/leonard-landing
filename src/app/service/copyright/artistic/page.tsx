...
const artisticCopyrightInfo: ArtisticCopyrightInfo[] = [
  ...
  },
  {
    ...
    description: 'Artistic copyrights last for the creators lifetime plus 60 years, ensuring long-term control and benefits for artists and their heirs.',
    category: 'Protection',
...
const copyrightServices = [
  {
    ...
    description: 'We assess the originality and eligibility of your artistic work.',
    image: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&q=80&w=1200",
    category: "Analysis",
  },
  {
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Expert copyright consultation services to protect your artistic works, from paintings and photographs to digital art and sculptures.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
              ...
              >
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      Artistic Copyright Overview
                    </motion.h1>

                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in artistic copyright to protect your visual creations. Our skilled team provides expert advice on copyright registration, enforcement, and management.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our copyright services include copyrightability analysis, registration strategy, enforcement support, and strategic planning to ensure your artistic works are protected effectively.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1541961017774-22349e4a1262?auto=format&fit=crop&q=80&w=1200" alt="Copyright Artistic visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-8 md:mb-12 lg:mb-16 text-center">
            <motion.h1
              ...
              viewport={{ once: true, margin: "0px 0px -100px 0px" }}
            >
              Artistic Copyright Information
            </motion.h1>
          </div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our copyright services ensure your artistic works are protected with strategic guidance and comprehensive copyright expertise.
              </p>
              <Link
                href="/contact"
