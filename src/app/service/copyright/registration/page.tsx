    ...
    <div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[170px] font-montserrat overflow-hidden">
          ...
          >
            ...
            <div className="text-center space-y-6">
              <h2 className="text-4xl font-bold mb-4">
                ...
                <span className="text-[#393E46]">Original Creations</span>
              </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#222831]">Copyright Registration</span>{' '}
      ...
      <section className="py-32 px-4 md:px-16 lg:px-24 bg-[#F7F7F7]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-[#222831]">Works Eligible</span>{' '}
              <span className="text-[#00ADB5]">for Copyright</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 px-4 md:px-16">
            {[
      ...
      <section className="py-32 px-4 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {[
              { step: '1. Prepare Application', description: 'Complete Form XIV, including a Statement of Particulars and Statement of Further Particulars, detailing the work and its creator.' },
              { step: '2. Submit Documents', description: 'Provide copies of the work, identity proof, NOC from co-authors or publishers if applicable, and pay the prescribed fees.' },
              { step: '3. Examination & Approval', description: 'The Copyright Office examines the application, may raise objections, and approves registration upon satisfaction, issuing a certificate.' },
              { step: '4. Publication', description: 'The registered work is published in the Copyright Office’s journal, providing public notice of your copyright ownership.' },
            ].map((step, index) => (
              <motion.div
                key={step.step}
                className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-[#00ADB5]/10"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-4">
              ...
              <span className="text-[#393E46]">Your Creations?</span>
            </h2>
