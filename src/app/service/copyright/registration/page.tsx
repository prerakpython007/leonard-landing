...
import { FileText, Clock, Shield, Book, PenTool, Music } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';
import { X } from 'lucide-react';

// Define the interface for copyright info
...
const copyrightInfo: CopyrightInfo[] = [
  {
    ...
    description: 'Legal right protecting original works of authorship.',
  ...
  },
  {
    ...
    description: 'Legal proof, enforcement rights, and statutory damages.',
    category: 'Advantages',
  ...
  },
  {
    ...
    description: 'Books, music, films, software, art, and photographs.',
  ...
  },
  {
    ...
    description: 'File Form XIV with required documents and fees.',
    category: 'Procedure',
  ...
  },
  {
    ...
    description: 'Exclusive rights for lifetime plus 60 years.',
    category: 'Protection',
...
const copyrightServices = [
  {
    ...
    description: 'We prepare and file your copyright application with accuracy.',
  ...
  },
  {
    icon: Shield,
    title: 'Legal Protection',
    description: 'We ensure your creative works receive maximum legal protection.',
  ...
  },
  {
    ...
    description: 'We manage deadlines and follow-ups for smooth registration.',
...
const benefits = [
  ...
  'Enable enforcement against infringement',
  'Enhance commercial value of your creations',
];
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Copyright Registration hero"
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light px-4">
            Protect your creative works with official copyright registration. Secure exclusive rights to your literary, artistic, musical, and dramatic creations.
          </p>
        </motion.div>
      </section>
          ...
          >
            <div className="relative flex flex-col lg:flex-row items-center">
                ...
                <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      At Leonard Corporate Solutions, we specialize in copyright registration to protect your creative works. Our expert team prepares applications, manages the filing process, and ensures your literary, artistic, musical, and dramatic creations receive the legal protection they deserve.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                      Our copyright registration services include application preparation, document collection, fee payment, and follow-up with the Copyright Office to secure your certificate of registration.
                    </p>
              ...
              <div className="relative z-10 h-64 md:h-96 lg:h-[520px] w-full lg:w-4/5">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1579389083078-4e7018379f7e?auto=format&fit=crop&q=80&w=1200" alt="Copyright Registration visual" className="h-full w-full object-cover object-right" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
              <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
                At Leonard Corporate Solutions, our copyright registration services ensure your creative works receive the legal protection they deserve with expert application preparation and filing.
              </p>
              <Link
                href="/contact"
