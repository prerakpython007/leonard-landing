...
const legalConsultationInfo = [
	{
		...
		description:
			'Legal consultation provides tailored advice on legal matters to help you navigate complex issues effectively.',
		category: 'Basics',
	},
	{
		id: 2,
		...
		description:
			'Informed decision-making, risk mitigation, and strategic planning with expert legal guidance.',
		category: 'Benefits',
	},
	{
		id: 3,
		title: 'Who Needs It?',
		description:
			'Businesses, startups, individuals, or anyone facing legal questions or decisions.',
	...
	},
	{
		...
		description:
			'Flexible sessions, from one-off meetings to ongoing support, based on your needs.',
		category: 'Timeline',
	},
	{
		id: 5,
		title: 'Our Approach',
		description:
			'Client-focused consultations with clear, actionable advice tailored to your situation.',
		category: 'Process',
	},
];
		...
		<div className="min-h-screen bg-[#EEEEEE] relative rounded-b-[50px] sm:rounded-b-[100px] md:rounded-b-[170px] font-montserrat overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          `,
			...
			>
				...
				>
					<h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-black relative inline-block tracking-tight">
						Legal Consultation
						<span className="absolute top-1/2 -left-8 sm:-left-12 md:-left-16 -translate-y-1/2 text-black text-3xl sm:text-4xl md:text-5xl animate-pulse opacity-50">
							✦
						</span>
						<span className="absolute top-1/2 -right-8 sm:-right-12 md:-right-16 -translate-y-1/2 text-black text-3xl sm:text-4xl md:text-5xl animate-pulse opacity-50">
							✦
						</span>
					</h1>
				...
				<div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
					...
					>
						...
						<div className="bg-white p-6 sm:p-8 rounded-xl shadow-md">
							...
							<p className="text-[#393E46]/80 text-sm sm:text-base">
								Our legal consultation services provide personalized advice to
								businesses, startups, and individuals. At Leonard Corporate
								Solutions, we help you understand your legal options, mitigate
								risks, and make informed decisions with expert guidance.
							</p>
						</div>
					</motion.div>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
							{legalConsultationInfo.map((info, index) => (
								<motion.div
									...
									viewport={{ once: true }}
								>
									<span className="absolute top-4 right-4 text-black text-lg sm:text-xl opacity-30 group-hover:opacity-100 transition-opacity duration-300">
										✦
									</span>
									<div className="mb-4">
									...
									<h3 className="text-lg sm:text-xl font-bold text-black mb-3 group-hover:text-black transition-colors duration-300">
										{info.title}
									</h3>
									<p className="text-[#393E46]/80 text-sm sm:text-base mb-4 line-clamp-3">
										{info.description}
									</p>
									<div className="flex items-center justify-between pt-4 border-t border-gray-100">
										...
										<Link
											...
											className="inline-flex items-center text-black font-medium hover:text-black transition-colors duration-300 text-sm sm:text-base"
										>
											Explore
											<svg
							...
							{[
								{
									title: 'Corporate Law',
									description:
										'Guidance on business formation, compliance, and governance.',
								},
								{
									title: 'Intellectual Property',
									description:
										'Advice on protecting trademarks, patents, and copyrights.',
								},
								{
									title: 'Employment Law',
									description:
										'Support for workplace policies, disputes, and contracts.',
								},
								{
							...
							{[
								{
									...
									description:
										'Discuss your legal needs and objectives with our experts.',
								},
								{
									step: '2. Issue Analysis',
									description:
										'We analyze your situation to identify risks and opportunities.',
								},
								{
									step: '3. Advice Delivery',
									description:
										'Receive clear, actionable legal advice tailored to your needs.',
								},
								{
									step: '4. Follow-Up',
									description:
										'Ongoing support to ensure your legal strategy remains effective.',
								},
							].map((process, index) => (
								<motion.div
									key={process.step}
					...
					<div className="bg-[#F7F7F7] py-12 sm:py-16 rounded-xl">
						...
						>
							...
							<p className="text-[#393E46]/80 mb-4 text-sm sm:text-base">
					...
					>
						<div className="relative py-8 sm:py-12">
							...
							<h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
								Ready for Expert Legal Advice?
							</h2>
							<p className="text-[#393E46] text-sm sm:text-lg leading-relaxed mb-6">
								Get personalized legal guidance with Leonard Corporate Solutions’
								consultation services. Contact us today to address your legal needs
								with confidence.
							</p>
							<Link
								href="/contact-us"
								className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-black text-white font-medium rounded-full hover:bg-black transition-colors duration-300 text-sm sm:text-base"
							>
