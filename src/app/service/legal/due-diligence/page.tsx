...
const dueDiligenceInfo = [
  {
    id: 1,
    title: 'What is Due Diligence?',
    description: 'Due diligence is a comprehensive investigation of legal, financial, and operational aspects to assess risks before major decisions.',
    category: 'Basics',
  },
  {
    id: 2,
    title: 'Benefits of Due Diligence',
    description: 'Informed decision-making, risk mitigation, and enhanced confidence in mergers, acquisitions, or investments.',
    category: 'Benefits',
  },
  {
    id: 3,
    title: 'Who Needs It?',
    description: 'Businesses, investors, or startups involved in mergers, acquisitions, or partnerships.',
    category: 'Eligibility',
  },
  {
    id: 4,
    title: 'Investigation Timeline',
    description: 'Ranges from weeks to months, depending on the scope and complexity of the transaction.',
    category: 'Timeline',
  },
  {
    id: 5,
    title: 'Our Approach',
    description: 'We conduct thorough, multi-faceted investigations to uncover risks and ensure informed decisions.',
    category: 'Process',
  },
];
        ...
        <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 md:space-y-24 lg:space-y-32">
          ...
          >
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-md">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#222831] mb-4">Make Informed Decisions</h2>
              <p className="text-[#393E46]/80 text-sm sm:text-base">
                Our due diligence services provide thorough investigations to uncover risks in mergers, acquisitions, or investments. At Leonard Corporate Solutions, we analyze legal, financial, and operational aspects to ensure you make confident, informed decisions.
              </p>
            </div>
          </motion.div>

          {/* Due Diligence Info Section */}
          <div>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831] mb-4">Due Diligence Essentials</h2>
              <div className="w-16 sm:w-24 h-1 bg-black mx-auto rounded-full"></div>
            </motion.div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
              {dueDiligenceInfo.map((info, index) => (
                <motion.div
                  key={info.id}
                ...
                >
                  ...
                  <div className="mb-4">
                    <span className="px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium bg-white/90 backdrop-blur-sm rounded-full text-black">
                      {info.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <Link
                      href={`/due/diligence/${info.id}`}
                      className="inline-flex items-center text-black font-medium hover:text-[#222831] transition-colors duration-300 text-sm sm:text-base"
                    >
                      Explore
          ...
          {/* Types of Due Diligence Section */}
          <div className="bg-[#F7F7F7] py-12 sm:py-16 rounded-xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831] mb-4">Types of Due Diligence</h2>
              <div className="w-16 sm:w-24 h-1 bg-black mx-auto rounded-full"></div>
            </motion.div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
              {[
                { title: 'Financial Due Diligence', description: 'Analyzing financial statements, cash flows, and liabilities.' },
                { title: 'Legal Due Diligence', description: 'Reviewing contracts, IP rights, and litigation risks.' },
                { title: 'Operational Due Diligence', description: 'Assessing business operations, processes, and efficiency.' },
                { title: 'Compliance Due Diligence', description: 'Ensuring adherence to regulatory and industry standards.' },
              ].map((type, index) => (
                <motion.div
                  key={type.title}
                  className="group bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 relative overflow-hidden"
          ...
          <div>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#222831] mb-4">Due Diligence Process</h2>
              <div className="w-16 sm:w-24 h-1 bg-black mx-auto rounded-full"></div>
            </motion.div>
            <div className="space-y-6 sm:space-y-8">
              {[
                { step: '1. Scope Definition', description: 'Identify the objectives and scope of the due diligence investigation.' },
                { step: '2. Data Collection', description: 'Gather relevant financial, legal, and operational documents.' },
                { step: '3. Analysis', description: 'Evaluate data to identify risks, liabilities, and opportunities.' },
                { step: '4. Reporting', description: 'Deliver a detailed report with findings and recommendations.' },
              ].map((process, index) => (
                <motion.div
                  key={process.step}
                  className="group bg-white p-6 sm:p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 relative overflow-hidden"
          ...
          <div className="bg-[#F7F7F7] py-12 sm:py-16 rounded-xl">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-lg sm:text-xl font-bold text-[#222831] mb-3">Who Can Request Due Diligence?</h3>
              <ul className="text-[#393E46]/80 list-disc list-inside mb-6 text-sm sm:text-base">
                <li>Businesses pursuing mergers or acquisitions</li>
                <li>Investors evaluating opportunities</li>
                <li>Startups entering partnerships</li>
              ...
              <ul className="text-[#393E46]/80 list-disc list-inside text-sm sm:text-base">
                ...
                <li>Operational and compliance records</li>
              </ul>
            </motion.div>
          </div>
          ...
          >
            <div className="relative py-8 sm:py-12">
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 sm:-bottom-6 sm:-left-6 sm:w-8 sm:h-8 border-b-2 border-l-2 border-black" />
              <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:-bottom-6 sm:-right-6 sm:w-8 sm:h-8 border-b-2 border-r-2 border-black" />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready for Due Diligence?</h2>
              <p className="text-[#393E46] text-sm sm:text-lg leading-relaxed mb-6">
                Make informed decisions with Leonard Corporate Solutions’ comprehensive due diligence services. Contact us today to mitigate risks and move forward confidently.
              </p>
              <Link
                href="/contact-us"
