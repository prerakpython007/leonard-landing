...
import { Scale, Shield, FileCheck, AlertTriangle, Search, Settings } from 'lucide-react';
...
export default function RegulatoryCompliancePage() {
  const features = [
    ...
    },
    {
      icon: FileCheck,
      title: "Documentation",
      description: "Maintaining required regulatory documentation."
    },
    {
      icon: AlertTriangle,
      title: "Violation Prevention",
      description: "Proactive compliance monitoring."
    },
    {
      icon: Search,
      title: "Regulatory Review",
      description: "Ongoing review of regulatory requirements."
    },
    {
      icon: Settings,
      title: "Process Implementation",
      description: "Setting up compliance processes."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto space-y-32">
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            ...
            <div className="text-[#393E46] space-y-6">
              <p className="text-lg leading-relaxed">
                Our regulatory compliance services help startups navigate complex regulatory requirements. We ensure your business operates within legal frameworks while maintaining efficiency and growth potential.
              </p>
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            <div className="text-[#393E46] space-y-6">
              ...
              <p className="text-lg leading-relaxed">
                Contact us to learn how our regulatory compliance services can help your startup navigate complex regulations while maintaining growth momentum.
              </p>
            </div>
          </motion.div>
        </div>
