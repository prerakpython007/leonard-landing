...
const regulatoryComplianceServices = [
  {
    ...
    category: "Analysis",
    detailedContent: `• Comprehensive regulatory landscape analysis
• Industry-specific compliance requirements identification
...
• Regulatory change tracking`
  },
  {
    ...
    category: "Planning",
    detailedContent: `• Customized compliance framework development
...
• Compliance certification preparation`
  },
  {
    ...
    category: "Monitoring",
    detailedContent: `• Regulatory change tracking and alerts
• Continuous compliance monitoring
• Regular compliance audits
• Compliance reporting
• Risk mitigation strategies
• Update implementation support
...
const benefits = [
  ...
  'Focus on growth with regulatory confidence',
];
            ...
            >
              <div className="bg-white/95 p-6 md:p-8 lg:p-12" style={{ clipPath: "polygon(0 0, calc(100% - 40px) 0, 100% 100%, 0 100%)" }}>
                <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-[#393E46]">
                    Our comprehensive approach includes regulatory mapping, compliance strategy development, and ongoing monitoring to ensure your business stays compliant as it grows.
                  </p>
                  <p className="text-base md:text-lg font-medium text-[#393E46]">
                    📩 For expert regulatory compliance support:{" "}
    ...
    >
      <div className="relative rounded-xl md:rounded-2xl py-8 md:py-12 backdrop-blur-sm text-center">
        <p className="text-center text-base md:text-lg leading-relaxed text-[#eeeeee] mb-6">
          At Leonard Corporate Solutions, our regulatory compliance services ensure your business stays compliant, avoids penalties, and focuses on growth with confidence.
        </p>
        <Link
          href="/contact"
