  ...
  const serviceCards = [
    {
      ...
      description:
        "Seamless company formation with expert guidance on choosing the optimal legal structure.",
      slug: "incorporation",
      image:
        "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=1400",
      category: "Formation",
      route: "/service/startup/incorporation",
    },
    {
      icon: FileText,
      title: "Founder Agreements",
      description:
        "Draft robust founder agreements to clarify roles, equity, and responsibilities.",
      slug: "founder-agreements",
      image:
        "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=1400",
      category: "Agreements",
      route: "/service/startup/founder-agreements",
    },
    {
      icon: DollarSign,
      title: "Investor Agreements",
      description:
        "Craft investor-friendly term sheets, SAFE notes, and equity agreements.",
      slug: "investor-agreements",
      image:
        "https://images.unsplash.com/photo-1556740760-3f6ccf6c6b13?auto=format&fit=crop&q=80&w=1400",
      category: "Funding",
      route: "/service/startup/investor-agreements",
    },
    {
      icon: Scale,
      title: "Regulatory Compliance",
      description:
        "Navigate startup-specific regulations to ensure compliance and avoid penalties.",
      slug: "regulatory-compliance",
      image:
        "https://images.unsplash.com/photo-1557426279-6f7f6f1f9c8b?auto=format&fit=crop&q=80&w=1400",
      category: "Compliance",
      route: "/service/startup/regulatory-compliance",
    },
    {
      icon: Package,
      title: "Intellectual Property Protection",
      description:
        "Safeguard your startup's IP with trademark, patent, and copyright services.",
      slug: "ip-protection",
      image:
        "https://images.unsplash.com/photo-1508385082359-f3a0e3d1c12b?auto=format&fit=crop&q=80&w=1400",
      category: "IP",
      route: "/service/startup/ip-protection",
    },
    {
      icon: UserCheck,
      title: "Employee & Contractor Agreements",
      description:
        "Create clear, compliant contracts for your team and freelancers.",
      slug: "employee-agreements",
      image:
        "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=1400",
      category: "Agreements",
      route: "/service/startup/employee-agreements",
    },
  ];
    ...
    <div className="font-montserrat relative min-h-screen overflow-hidden bg-[#EEEEEE]">
      ...
      <section className="relative h-[75vh] md:h-[85vh] lg:h-[95vh] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?auto=format&fit=crop&q=80&w=1600"
            alt="Startup hero"
        ...
        >
          ...
          <p className="mt-6 max-w-3xl text-base sm:text-lg md:text-xl text-white/90 font-light">
            Protect & grow your startup — incorporation, funding docs, IP and compliance support.
          </p>
        </motion.div>
      </section>
              ...
              >
                ...
                >
                  <div className="space-y-6">
                    ...
                    >
                      Startup Legal Overview
                    </motion.h2>

                    <p className="text-lg leading-relaxed text-[#393E46]">
                      BrandSecure empowers startups with tailored legal support — from formation and fundraising docs to IP protection and employment contracts. We help early-stage companies build a strong legal foundation for scalable growth.
                    </p>

                    <p className="text-lg leading-relaxed text-[#393E46]">
                      Our team focuses on practical, startup-friendly solutions: founder and investor agreements, trademark strategy, compliance checks, and employment documentation.
                    </p>

                    <p className="text-lg font-medium text-[#393E46]">
                      📩 For personalized startup legal support, write to{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-16">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-gray-300 max-w-2xl mx-auto">
              Incorporation, funding docs, IP protection and employment agreements designed for startups.
            </p>
          </div>
          ...
          <motion.div className="relative mx-auto mt-16 max-w-3xl px-8" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
            <div className="relative rounded-2xl py-12">
              <p className="text-center text-lg leading-relaxed text-[#eeeeee]">
                BrandSecure’s startup legal services are designed to help founders build, protect and scale their ventures with confidence.
              </p>
            </div>
          </motion.div>
        </div>
