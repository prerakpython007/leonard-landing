...
import { Package, Shield, FileText, Search, AlertTriangle, Globe } from 'lucide-react';
  ...
  const features = [
    {
      icon: Shield,
      title: "IP Strategy",
      description: "Comprehensive IP protection strategy development."
    },
    {
      icon: FileText,
      title: "Patent Services",
      description: "Patent application and protection support."
    },
    {
      icon: Package,
      title: "Trademark Protection",
      description: "Trademark registration and enforcement."
    },
    {
      icon: Globe,
      title: "Copyright Services",
      description: "Copyright registration and management."
    },
    {
      icon: Search,
      title: "IP Monitoring",
      description: "Continuous monitoring for IP infringement."
    },
    {
      icon: AlertTriangle,
      title: "Risk Management",
      description: "IP risk assessment and mitigation."
    }
  ];
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            ...
            <div className="text-[#393E46] space-y-6">
              <p className="text-lg leading-relaxed">
                Our IP protection services help startups secure and manage their intellectual property assets. We provide comprehensive support across patents, trademarks, copyrights, and trade secrets.
              </p>
              <ul className="space-y-4 list-none pl-5">
                {ipPoints.map((item, index) => (
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            <div className="text-[#393E46] space-y-6">
              <h2 className="text-3xl font-bold text-center mb-8">
                ...
                <span className="text-[#222831]">IP Services</span>
              </h2>
              <p className="text-lg leading-relaxed">
                Contact us to learn how our IP protection services can help secure and manage your startup's intellectual property portfolio.
              </p>
            </div>
          </motion.div>
        </div>
