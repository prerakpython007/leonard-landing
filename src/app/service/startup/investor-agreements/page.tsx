...
import { DollarSign, FileText, Scale, Shield, Briefcase, HandshakeIcon } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Structuring and negotiating investment terms."
    },
    {
      icon: FileText,
      title: "Agreement Drafting",
      description: "Expert drafting of investment agreements."
    },
    {
      icon: Scale,
      title: "Rights Balancing",
      description: "Balancing investor and company interests."
    },
    {
      icon: Shield,
      title: "Risk Management",
      description: "Identifying and mitigating investment risks."
    },
    {
      icon: HandshakeIcon,
      title: "Negotiation Support",
      description: "Expert support in investor negotiations."
    },
    {
      icon: Briefcase,
      title: "Transaction Support",
      description: "End-to-end investment transaction support."
    }
  ];
      ...
      <motion.section className="relative h-[80vh] flex items-center justify-center px-4 md:px-16 lg:px-24">
        ...
        <motion.div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-8 text-xl text-[#393E46]/80 max-w-2xl mx-auto font-light">
            Expert Guidance for Investment Transactions
          </p>
        </motion.div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto space-y-32">
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            ...
            <div className="text-[#393E46] space-y-6">
              <p className="text-lg leading-relaxed">
                Our investor agreement services provide comprehensive support in structuring and documenting investment transactions. We ensure clear, fair, and legally sound agreements that protect all parties' interests.
              </p>
          ...
          <motion.div className="relative max-w-3xl mx-auto px-8">
            <div className="text-[#393E46] space-y-6">
              ...
              <p className="text-lg leading-relaxed">
                Contact us to learn how our investor agreement services can help structure and document your investment transactions effectively.
              </p>
            </div>
          </motion.div>
        </div>
