...
const serviceCards = [
  {
    ...
    description: "Conduct thorough searches to ensure your trademark is unique and available for registration."
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    description: "Monitor and enforce your trademark rights to prevent infringement and maintain brand integrity."
  }
]
