      ...
      <div className="relative z-10 space-y-12 sm:space-y-16 md:space-y-24">
        ...
        <section className="py-16 sm:py-24 px-4 md:px-16 lg:px-24 relative mt-24 sm:mt-40">
          <div className="max-w-7xl mx-auto relative">
            ...
            <div className="absolute -top-20 right-10 text-black text-7xl animate-pulse opacity-30">✦</div>
            <div className="absolute bottom-10 left-0 text-black text-6xl animate-pulse opacity-20">✦</div>
            ...
            <div className="grid md:grid-cols-2 gap-20 items-center relative">
              ...
              >
                <div>
                  <span className="text-black font-medium tracking-wider uppercase">Our Story</span>
                ...
                <div className="relative space-y-6 p-6 sm:p-8">
                  ...
                  <p className="text-[#393E46] text-base sm:text-lg leading-relaxed">
                    <span className="absolute -left-4 top-0 text-black opacity-20">✦</span>
              ...
              >
                {/* Background Shape */}
                <div className="absolute inset-0 bg-black/10 rounded-[30px] transform rotate-6"></div>
                ...
                {/* Decorative Star */}
                <span className="absolute -right-10 top-10 text-black text-5xl animate-pulse">✦</span>
              </motion.div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto space-y-16 sm:space-y-32">
            ...
            >
              <div className="relative">
                <span className="absolute -top-10 -left-10 text-black text-7xl animate-pulse opacity-20">✦</span>
                ...
                <div className="mt-8 space-y-4">
                  <h4 className="text-xl font-bold text-black mb-4">🚀 Pillars of Our Vision:</h4>
              ...
              <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-xl">
                <div className="absolute inset-0 bg-black/10 rounded-2xl transform rotate-3"></div>
                <Image
            ...
            >
              ...
              <div className="order-1 md:order-2 relative">
                <span className="absolute -top-10 -right-10 text-black text-7xl animate-pulse opacity-20">✦</span>
                ...
                <div className="mt-8 grid grid-cols-2 gap-6">
                  <h4 className="text-xl font-bold text-black col-span-2 mb-2">✨ What Drives Us:</h4>
        ...
        <section className="py-16 sm:py-32 px-4 md:px-16 lg:px-24 relative">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="absolute -top-10 left-1/2 -translate-x-1/2 text-black text-6xl animate-pulse opacity-20">✦</span>
              <h2 className="text-5xl font-bold text-[#222831] mb-4 relative inline-block">
                Meet Our Team
                <span className="absolute -right-8 top-0 text-black text-4xl animate-pulse">✦</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
              ...
              <h3 className="col-span-full text-xl sm:text-2xl font-bold text-black mt-8 sm:mt-12 mb-4 sm:mb-6 first:mt-0">
                👨‍💼 Leadership
              </h3>
                ...
                >
                  <div className="relative h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
                      <span className="inline-block px-3 py-1 text-xs font-medium bg-white/90 rounded-full text-black mb-3">
                        {member.role}
                      </span>
              ...
              <h3 className="col-span-full text-xl sm:text-2xl font-bold text-black mt-8 sm:mt-12 mb-4 sm:mb-6">
                ⚖️ Legal & Taxation
              </h3>
