        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-[#222831] mb-6 relative">
              <span className="relative z-10">FSSAI Licensing Overview</span>
              <span className="absolute bottom-0 left-0 h-3 w-20 bg-[#00ADB5]/20 -z-10"></span>
            </h2>
            <p className="text-[#393E46] text-lg leading-relaxed">
              We provide end-to-end solutions to meet all your FSSAI (Food Safety and Standards Authority of India) licensing
              needs. Our expert team ensures seamless compliance with FSSAI regulations, helping food businesses of all sizes
              obtain and maintain their licenses efficiently. From eligibility consultation to timely renewals, we handle every
              aspect of the licensing process with precision and care.
            </p>
          ...
          >
            <div className="text-center">
              <h2 className="text-4xl font-bold text-[#222831] mb-4">Our FSSAI Services</h2>
