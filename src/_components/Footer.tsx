...
export default function Footer() {
  return (
    <footer className="bg-[#000000] text-white relative flex flex-col justify-between pt-16 sm:pt-20 md:pt-24 lg:pt-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            <h3 className="text-white text-xl font-bold">Leonard Solutions</h3>
            ...
            <div className="flex gap-4">
              {[
                ...
                <Link key={i} href={href} target="_blank" rel="noopener noreferrer">
                  <Icon className="text-white hover:text-white transition-all cursor-pointer" />
                </Link>
              ))}
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-0">
            <h3 className="text-white text-xl font-bold mb-4 relative inline-block">
              Quick Links
              <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-black transform origin-left scale-x-0 transition-transform group-hover:scale-x-100" />
            </h3>
      ...
      <div className="w-full bg-black overflow-hidden border-t border-white/10 mt-16 sm:mt-20 md:mt-24 lg:mt-32">
        {/* Copyright bar */}
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 py-4 sm:py-6 border-t border-white/10">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 sm:gap-6">
              <Link href="/privacy-policy" className="text-gray-400 hover:text-black text-sm">
                Privacy Policy
              </Link>
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center">
              <span className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold tracking-tighter">
                <span className="text-[#EEEEEE]">LEONARD </span>
                <span className="text-[#EEEEEE]">SOLUTIONS</span>
              </span>
              <span className="text-[#EEEEEE] text-4xl sm:text-5xl md:text-6xl lg:text-7xl mx-6 sm:mx-8 md:mx-12">✦</span>
            </div>
          ))}
        </motion.div>
      </div>
