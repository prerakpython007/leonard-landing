...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute top-[45%] left-0 -translate-y-1/2 transform text-[150px] text-black opacity-10 sm:text-[200px] md:text-[300px]">
        ✦
      </span>
      <span className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 transform text-[200px] text-black opacity-[0.07] sm:text-[250px] md:text-[350px]">
        ✦
      </span>
      <span className="absolute top-[45%] right-0 -translate-y-1/2 transform text-[150px] text-black opacity-10 sm:text-[200px] md:text-[300px]">
        ✦
      </span>
      ...
      <motion.div className="relative mb-12 md:mb-16 lg:mb-20 w-full text-center mt-8 sm:mt-12 md:mt-16">
        <span className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-wider text-[#393E46]">
          <strong className="mr-2 text-black">ABOUT</strong>
          US
        </span>
      </motion.div>
      ...
      <div className="flex w-full flex-col items-center gap-12 sm:gap-16 lg:gap-20 lg:flex-row max-w-7xl mx-auto pb-8 sm:pb-12 md:pb-16">
        ...
        <motion.div className="flex-1 text-center px-4 sm:px-6 lg:px-8 lg:text-left">
          <h2 className="mb-4 md:mb-6 text-2xl sm:text-3xl md:text-4xl font-bold text-black">
          ...
          <Link href="/about-us">
            <button className="w-full sm:w-auto rounded bg-black px-6 sm:px-8 py-3 sm:py-4 font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-black">
              Read More
            </button>
          </Link>
        </motion.div>
        ...
        {/* Dividers */}
        <motion.div className="hidden h-[300px] md:h-[400px] w-px bg-gradient-to-b from-transparent via-black to-transparent lg:mx-4 xl:mx-8 lg:block" />
        <motion.div className="my-6 md:my-8 block h-px w-[90%] sm:w-4/5 bg-gradient-to-r from-transparent via-black to-transparent lg:hidden" />
        ...
        <motion.div className="flex-1 w-full lg:w-auto">
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 max-w-[600px] mx-auto">
            {[
              ...
              <motion.div
                key={index}
                className="w-full rounded-lg bg-black p-3 sm:p-4 md:p-6 text-center"
              ...
              >
                <motion.h3
                  ...
                  className="mb-1 sm:mb-2 text-xl sm:text-2xl md:text-3xl font-bold text-black"
                >
                  {stat.number}
                </motion.h3>
                <motion.p
