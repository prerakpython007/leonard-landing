    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0  bg-black/80 backdrop-blur-sm grid place-items-center p-5 z-100"
        >
          <motion.div
            initial={{ scale: 0.9, opacity: 0, y: 20 }}
            animate={{ scale: 1, opacity: 1, y: 0 }}
            exit={{ scale: 0.9, opacity: 0, y: 20 }}
            className="relative bg-[#EEEEEE] p-8 md:p-12  w-[95%] md:w-[1000px] lg:w-[1100px] shadow-2xl overflow-hidden"
          >
            {/* Background Pattern */}
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-xl font-montserrat font-light tracking-wider uppercase relative inline-block">
            ...
            {/* Content */}
            <div className="text-[#393E46] font-bold space-y-6 font-montserrat text-sm md:text-base leading-relaxed">
              <p>
            ...
            <div className="flex justify-end items-center gap-4 mt-8">
              <motion.button
                ...
                className="px-6 py-3  border border-[#393E46]/20 text-[#393E46] font-montserrat text-sm tracking-wide hover:bg-[#EEEEEE]/10 transition-colors"
              >
                I Disagree
              </motion.button>
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={handleAgree}
                className="px-6 py-3  bg-[#00ADB5] text-white font-montserrat text-sm tracking-wide hover:bg-[#00ADB5]/90 transition-colors"
              >
                I Agree
              </motion.button>
            </div>
